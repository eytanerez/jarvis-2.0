...
# 5. Symlinks the 'jarvis' CLI command into a user-facing bin dir
...
# ============================================================================
# Seed bundled skills into ~/.jarvis/skills/
# ============================================================================

JARVIS_SKILLS_DIR="${JARVIS_HOME:-$HOME/.jarvis}/skills"
mkdir -p "$JARVIS_SKILLS_DIR"
...
echo "Other commands:"
echo "  jarvis status        # Check configuration"
if is_termux; then
    echo "  jarvis gateway       # Run gateway in foreground"
else
    echo "  jarvis gateway install # Install gateway service (messaging + cron)"
fi
echo "  jarvis cron list     # View scheduled jobs"
echo "  jarvis doctor        # Diagnose issues"
echo ""
