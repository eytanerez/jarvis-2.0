...
DEFAULT_DATASETS = [
    ...
    "NousResearch/jarvis-agent-megascience-sft1",
    "NousResearch/Jarvis-Brain-Thinking-GLM-4.7-SFT2",
    "NousResearch/Jarvis-Brain-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-jarvis-agent"
]
