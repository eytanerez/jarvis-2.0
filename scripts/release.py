...
ACP_REGISTRY_MANIFEST = REPO_ROOT / "acp_registry" / "brain.json"
...
AUTHOR_MAP = {
    ...
    "jarvis@marian.local": "Schrotti77",
    ...
    "274096618+jarvis-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "jarvis@nousresearch.com": "NousResearch",
    ...
    "jarvis@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyajarvis.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (JARVIS_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (JARVIS_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: jarvis-eval community link)
    ...
    "jarvisagent26@gmail.com": "jarvisagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+jarvisagent26@users.noreply.github.com": "jarvisagent26",
    ...
    "vigo@jarvis": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.jarvis@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Jarvis runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level JARVIS_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Jarvis
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"jarvis-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "jarvis@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/jarvis-agent",
    ...
    lines.append(f"# Jarvis v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Jarvis. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Jarvis Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Jarvis Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Jarvis v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Jarvis v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Jarvis v{new_version} ({calver_date})' "
