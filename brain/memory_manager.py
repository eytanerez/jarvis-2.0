...
Single integration point in run_brain.py. Replaces scattered per-backend
...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        _core_tool_names = set(_JARVIS_CORE_TOOLS)
    ...
    def _strip_skill_scaffolding(text: str) -> Optional[str]:
        ...
        When a user invokes a /skill or /bundle, Jarvis expands the turn into
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        ``AIBrain.session_id`` without tearing the provider down.
