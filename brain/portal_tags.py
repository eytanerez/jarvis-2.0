...
Tag shape (sent in OpenAI-compatible ``extra_body['tags']``):
    ...
    [
        "product=jarvis-agent",
        "client=jarvis-client-v<__version__>",
    ]
...
* Four call sites (main loop profile, aux client, run_brain compression
...
``jarvis_cli.__version__`` is the canonical source of truth.
"""
