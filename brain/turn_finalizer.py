...
Extracted from ``brain/conversation_loop.py`` as part of the god-file
decomposition campaign (``~/.jarvis/plans/god-file-decomposition.md``, Phase 1
...
keep the exact logger name (``"brain.conversation_loop"``).
"""
...
def finalize_turn(
    ...
    *,
    ...
    """
    from brain.conversation_loop import logger
    ...
    if final_response is None and (
        ...
        _kanban_task = os.environ.get("JARVIS_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    # Always logged at INFO so brain.log captures WHY every turn ended.
