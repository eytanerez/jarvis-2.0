"""Language Server Protocol (LSP) integration for Jarvis.
...
from brain.lsp.manager import LSPService

logger = logging.getLogger("brain.lsp")
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``jarvis chat`` exit would leak pyright processes that
