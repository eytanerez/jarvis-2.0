...
that the main retry loop in run_brain.py consults for every API failure.
"""
...
def classify_api_error(
    ...
    *,
    ...
    # in run_brain.py rebuilds the Anthropic client with the beta stripped
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # the retryability check in run_brain.py.  If those succeed, the
