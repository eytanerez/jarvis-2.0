...
class ContextEngine(ABC):
    ...
    # -- Token state (read by run_brain.py for display/logging) ------------
    #
    # Engines MUST maintain these. run_brain.py reads them directly.
    ...
    # -- Compaction parameters (read by run_brain.py for preflight) --------
    #
    ...
    def on_session_start(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may include jarvis_home, platform, model, etc.
        """
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Default returns the standard fields run_brain.py expects.
        """
        return {
