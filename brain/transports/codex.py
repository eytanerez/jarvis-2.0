...
Delegates to the existing adapter functions in brain/codex_responses_adapter.py.
...
from brain.transports.base import ProviderTransport
from brain.transports.types import NormalizedResponse, ToolCall
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: Dict[str, Any]) -> str:
        ...
        from brain.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from brain.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from run_brain import DEFAULT_AGENT_IDENTITY
        ...
        # that would silently route around Jarvis's web-provider config and
        ...
        # native search engine for xAI sessions instead of Jarvis's
        # configured web provider (Tavily/etc.), and those results bypass
        # Jarvis's tool-trace / citation plumbing (they arrive baked into the
        ...
        if reasoning_enabled and is_xai_responses:
            from brain.model_metadata import grok_supports_reasoning_effort

            # Ask xAI to echo back encrypted reasoning items so we can
            # replay them on subsequent turns for cross-turn coherence.
            # See brain/codex_responses_adapter._chat_messages_to_responses_input
...
from brain.transports import register_transport  # noqa: E402
