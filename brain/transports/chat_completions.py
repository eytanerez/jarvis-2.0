...
from brain.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from brain.prompt_builder import DEVELOPER_ROLE_MODELS
from brain.transports.base import ProviderTransport
from brain.transports.types import NormalizedResponse, ToolCall, Usage


def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Jarvis/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Jarvis'
    ...
    # is stricter (low/high). Clamp Jarvis' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Jarvis-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Jarvis-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # is shared with run_brain's summary path so both stay in sync.
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            try:
                from brain.gemini_native_adapter import is_native_gemini_base_url
