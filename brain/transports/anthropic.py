...
Delegates to the existing adapter functions in brain/anthropic_adapter.py.
...
from brain.transports.types import NormalizedResponse
...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from brain.anthropic_adapter import convert_tools_to_anthropic
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        """
        import json
        from brain.anthropic_adapter import _to_plain_data, _sanitize_replay_block
        from brain.transports.types import ToolCall
        ...
        # tests/brain/test_anthropic_thinking_block_order.py.
        ordered_blocks = []
