...
A runner that uses Jarvis Brain's built-in execution environments
(local, docker, modal) and outputs trajectories in the Jarvis Brain format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Jarvis Brain's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Jarvis format (from/value pairs with <tool_call>/<tool_response> XML)
...
from brain.tool_dispatch_helpers import make_tool_result_message
...
# ============================================================================
# Terminal Tool Definition (matches Jarvis Brain format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Jarvis Brain's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Jarvis Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Jarvis Brain's built-in execution environments
    and outputs trajectories in Jarvis Brain format.
    """
...
Complete the user's task step by step."""
        ...
        # Convert to Jarvis trajectory format
        trajectory = self._convert_to_jarvis_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Jarvis trajectory format output.
