...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      jarvisNpmLib = self'.packages.default.passthru.jarvisNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. jarvis-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Jarvis dev shell"
          ${combinedNonNpm}
          ${jarvisNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'jarvis' to start."
        '';
      };
    };
}
