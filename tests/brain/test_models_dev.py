...
class TestLookupModelsDevContext:
    @patch("brain.models_dev.fetch_models_dev")
...
class TestFetchModelsDev:
    @patch("brain.models_dev.requests.get")
    ...
    def test_force_refresh_skips_disk_cache(self, mock_get):
        ...
        disk-cache fast path. Used by ``jarvis config refresh`` and
...
class TestGetModelCapabilities:
    ...
    def test_vision_from_attachment_flag(self):
        ...
        with patch("brain.models_dev.fetch_models_dev", return_value=CAPS_REGISTRY):
