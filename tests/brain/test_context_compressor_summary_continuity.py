...
from brain.context_compressor import ContextCompressor, SUMMARY_PREFIX
...
def test_existing_previous_summary_is_not_serialized_again_as_new_turn():
    ...
    with patch("brain.context_compressor.call_llm", return_value=_response("updated summary")) as mock_call:
