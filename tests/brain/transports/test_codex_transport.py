...
@pytest.fixture
def transport():
    import brain.transports.codex  # noqa: F401
...
class TestCodexBuildKwargs:
    ...
    def test_xai_reasoning_effort_passed(self, transport):
        ...
        # tests/run_brain/test_codex_xai_oauth_recovery.py for the
        # full history.
    ...
    def test_xai_does_not_inject_native_web_search_without_client_web_search(self, transport):
        ...
        would silently bypass Jarvis's web-provider config and tool-trace
