"""Tests for CodexEventProjector — codex item/* events → Jarvis messages list.
...
from brain.transports.codex_event_projector import (
    CodexEventProjector,
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Jarvis' message alternation invariant."""
