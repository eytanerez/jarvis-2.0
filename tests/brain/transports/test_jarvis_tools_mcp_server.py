"""Tests for the jarvis-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from brain.transports import jarvis_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from brain.transports.jarvis_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_jarvis_specific_tools_listed(self):
        """The Jarvis-specific tools should be present so users on the
    ...
    def test_agent_loop_tools_not_exposed(self):
        ...
        running AIBrain context to dispatch, so a stateless MCP callback
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `jarvis chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import brain.transports.jarvis_tools_mcp_server as m
