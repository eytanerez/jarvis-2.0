...
import brain.transports.codex_app_server_session as session_mod
...
class TestRunTurn:
    ...
    def test_startup_failure_returns_error_with_stderr(self):
        ...
        AIBrain surfaces a clean diagnostic instead of crashing the turn."""
        client = FakeClient()
        client.set_stderr_tail([
...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_jarvis_tools_auto_accepts(self):
        """When codex elicits on behalf of jarvis-tools (our own callback),
