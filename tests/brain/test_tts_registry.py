"""Tests for brain/tts_registry.py and brain/tts_provider.py.
...
from brain.tts_provider import (
...
class TestRegistration:
    ...
    def test_rejects_builtin_shadow_with_warning(self, builtin, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="brain.tts_registry"):
            tts_registry.register_provider(p)
    ...
    def test_reregistration_overwrites(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="brain.tts_registry"):
...
class TestBuiltinSync:
    """``_BUILTIN_NAMES`` in brain/tts_registry.py is duplicated from
    ...
    def test_registry_builtins_match_dispatcher_builtins(self):
        ...
        assert tts_registry._BUILTIN_NAMES == BUILTIN_TTS_PROVIDERS, (
            "brain.tts_registry._BUILTIN_NAMES and "
