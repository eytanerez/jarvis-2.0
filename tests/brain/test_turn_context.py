"""Unit tests for the extracted turn prologue (``brain/turn_context.py``).
...
``AIBrain`` or hitting any provider.
"""
...
from brain.turn_context import TurnContext, build_turn_context
...
def _stub_runtime_main():
    ...
    """
    with patch("brain.auxiliary_client.set_runtime_main", lambda *a, **k: None):
        yield
