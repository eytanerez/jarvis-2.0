"""Tests for get_tool_emoji in brain/display.py — skin + registry integration."""
...
class TestGetToolEmoji:
    ...
    def test_returns_registry_emoji_when_no_skin(self):
        ...
        with mock_patch("brain.display._get_skin", return_value=None), \
             mock_patch("brain.display.registry", mock_registry, create=True):
    ...
    def test_skin_override_takes_precedence(self):
        ...
        with mock_patch("brain.display._get_skin", return_value=skin):
...
class TestSkinConfigToolEmojis:
    ...
    def test_build_skin_config_includes_tool_emojis(self):
        from jarvis_cli.skin_engine import _build_skin_config
        data = {
            "name": "custom",
