"""Tests for brain/system_prompt.py — context-file cwd wiring."""
...
def _captured_context_cwd(agent):
    ...
    with (
        patch("run_brain.load_soul_md", return_value=""),
        patch("run_brain.build_nous_subscription_prompt", return_value=""),
        patch("run_brain.build_environment_hints", return_value=""),
        patch("run_brain.build_context_files_prompt", side_effect=fake_context_files),
    ):
...
def _stable_prompt(agent):
    with (
        ...
        patch("run_brain.build_nous_subscription_prompt", return_value=""),
        patch("run_brain.build_environment_hints", return_value=""),
        patch("run_brain.build_context_files_prompt", return_value=""),
    ):
...
class TestCodingContextBlock:
    ...
    def test_absent_when_off(self, monkeypatch, tmp_path):
        ...
        with patch("brain.coding_context._coding_mode", return_value="off"):
            stable = _stable_prompt(agent)
