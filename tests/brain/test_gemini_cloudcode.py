...
Covers:
- brain/google_oauth.py — PKCE, credential I/O with packed refresh format,
  token refresh dedup, invalid_grant handling, headless paste fallback
- brain/google_code_assist.py — project discovery, VPC-SC fallback, onboarding
  with LRO polling, quota retrieval
- brain/gemini_cloudcode_adapter.py — OpenAI↔Gemini translation, request
...
class TestPkce:
    def test_verifier_and_challenge_s256_roundtrip(self):
        from brain.google_oauth import _generate_pkce_pair
...
class TestRefreshParts:
    def test_parse_bare_token(self):
        from brain.google_oauth import RefreshParts
...
class TestClientCredResolution:
    def test_env_override(self, monkeypatch):
        from brain.google_oauth import _get_client_id

        monkeypatch.setenv("JARVIS_GEMINI_CLIENT_ID", "custom-id.apps.googleusercontent.com")
    ...
    def test_shipped_default_used_when_no_env(self):
        ...
        from brain.google_oauth import _get_client_id, _DEFAULT_CLIENT_ID
    ...
    def test_shipped_default_secret_present(self):
        from brain.google_oauth import _DEFAULT_CLIENT_SECRET, _get_client_secret
    ...
    def test_falls_back_to_scrape_when_defaults_wiped(self, tmp_path, monkeypatch):
        ...
        from brain import google_oauth
...
class TestCredentialIo:
    def _make(self):
        from brain.google_oauth import GoogleCredentials
    ...
    def test_save_and_load_packed_refresh(self):
        from brain.google_oauth import load_credentials, save_credentials
    ...
    def test_save_uses_0600_permissions(self):
        from brain.google_oauth import _credentials_path, save_credentials
...
class TestGetValidAccessToken:
    def _save(self, **over):
        from brain.google_oauth import GoogleCredentials, save_credentials
    ...
    def test_returns_cached_when_fresh(self):
        from brain.google_oauth import get_valid_access_token
...
class TestProjectIdResolution:
    ...
    def test_env_vars_checked(self, monkeypatch, env_var):
        from brain.google_oauth import resolve_project_id_from_env
    ...
    def test_priority_order(self, monkeypatch):
        ...
        monkeypatch.setenv("JARVIS_GEMINI_PROJECT_ID", "higher-priority")
...
class TestHeadlessDetection:
    def test_detects_ssh(self, monkeypatch):
        from brain.google_oauth import _is_headless
...
class TestCodeAssistVpcScDetection:
    def test_detects_vpc_sc_in_json(self):
        from brain.google_code_assist import _is_vpc_sc_violation
...
class TestLoadCodeAssist:
    def test_parses_response(self, monkeypatch):
        from brain import google_code_assist
...
class TestResolveProjectContext:
    def test_configured_shortcircuits(self, monkeypatch):
        from brain.google_code_assist import resolve_project_context
        ...
        monkeypatch.setattr(
            "brain.google_code_assist._post_json", should_not_be_called,
        )
    ...
    def test_env_shortcircuits(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "brain.google_code_assist._post_json",
...
class TestBuildGeminiRequest:
    def test_user_assistant_messages(self):
        from brain.gemini_cloudcode_adapter import build_gemini_request
...
class TestWrapCodeAssistRequest:
    def test_envelope_shape(self):
        from brain.gemini_cloudcode_adapter import wrap_code_assist_request
...
class TestTranslateGeminiResponse:
    def test_text_response(self):
        from brain.gemini_cloudcode_adapter import _translate_gemini_response
    ...
    def test_finish_reason_mapping(self):
        from brain.gemini_cloudcode_adapter import _map_gemini_finish_reason
...
class TestTranslateStreamEvent:
    def test_parallel_calls_to_same_tool_get_unique_indices(self):
        ...
        """
        from brain.gemini_cloudcode_adapter import _translate_stream_event
...
class TestMakeStreamChunk:
    def test_reasoning_only_chunk_has_content_none(self):
        from brain.gemini_cloudcode_adapter import _make_stream_chunk
...
class TestGeminiCloudCodeClient:
    def test_client_exposes_openai_interface(self):
        from brain.gemini_cloudcode_adapter import GeminiCloudCodeClient
...
class TestGeminiHttpErrorParsing:
    ...
    def test_model_capacity_exhausted_produces_friendly_message(self):
        from brain.gemini_cloudcode_adapter import _gemini_http_error
        ...
        # response attr is preserved for run_brain's Retry-After header path.
    ...
    def test_status_code_flows_through_error_classifier(self):
        ...
        """
        from brain.gemini_cloudcode_adapter import _gemini_http_error
        from brain.error_classifier import classify_api_error, FailoverReason
...
class TestProviderRegistration:
    ...
    def test_determine_api_mode(self):
        from jarvis_cli.providers import determine_api_mode
