...
from brain.credits_tracker import CreditsState, parse_credits_headers
...
class TestVersionValidation:
    ...
    def test_version_greater_than_1_warns_once(self, caplog):
        ...
        import brain.credits_tracker as ct
        ...
        try:
            ...
            with caplog.at_level(logging.WARNING, logger="brain.credits_tracker"):
