...
from brain.billing_view import (
    AutoReload,
    BillingState,
    CardInfo,
    MonthlyCap,
...
import jarvis_cli.nous_billing as nb
...
def test_portal_base_url_env_override(monkeypatch):
    monkeypatch.setenv("JARVIS_PORTAL_BASE_URL", "https://preview.example.com/")
    assert resolve_portal_base_url() == "https://preview.example.com"


def test_portal_base_url_falls_back_to_state(monkeypatch):
    monkeypatch.delenv("JARVIS_PORTAL_BASE_URL", raising=False)
