"""Tests for brain/display.py — build_tool_preview() and inline diff previews."""
...
class TestCuteToolMessagePreviewLength:
    ...
    def test_path_preview_uses_positive_configured_limit_not_default(self):
        set_tool_preview_max_len(80)
        path = "/tmp/jarvis-test-preview-length/deeply/nested/path/test-output.txt"
...
class TestEditDiffPreview:
    ...
    def test_render_edit_diff_with_delta_handles_renderer_errors(self, monkeypatch):
        ...
        monkeypatch.setattr("brain.display._summarize_rendered_diff_sections", MagicMock(side_effect=RuntimeError("boom")))
