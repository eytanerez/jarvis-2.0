...
def test_custom_endpoint_anthropic_messages_builds_anthropic_wrapper():
    ...
    from brain.auxiliary_client import _try_custom_endpoint, AnthropicAuxiliaryClient

    with patch(
        "brain.auxiliary_client._resolve_custom_runtime",
        return_value=(
...
def test_custom_endpoint_anthropic_messages_falls_back_when_sdk_missing():
    ...
    from brain.auxiliary_client import _try_custom_endpoint
