"""Tests for brain/image_routing.py — the per-turn image input mode decision."""
...
class TestDecideImageInputMode:
    def test_explicit_native_overrides_everything(self):
        ...
        with patch("brain.image_routing._lookup_supports_vision", return_value=False):
    ...
    def test_explicit_text_overrides_everything(self):
        ...
        with patch("brain.image_routing._lookup_supports_vision", return_value=True):
    ...
    def test_auto_with_unknown_model(self):
        with patch("brain.image_routing._lookup_supports_vision", return_value=None):
    ...
    def test_auto_uses_text_for_text_only_modalities_even_with_attachment_flag(self):
        ...
        with patch("brain.models_dev.fetch_models_dev", return_value=registry):
...
class TestLargeImageHandling:
    ...
    retry time in ``run_brain._try_shrink_image_parts_in_messages`` rather
    ...
    def test_large_image_passes_through_unchanged(self, tmp_path: Path):
        ...
        from brain import image_routing as _ir
