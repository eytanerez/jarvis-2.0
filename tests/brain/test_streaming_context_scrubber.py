"""Unit tests for StreamingContextScrubber (brain/memory_manager.py).
...
from brain.memory_manager import StreamingContextScrubber, sanitize_context
...
class TestBuildMemoryContextBlockWarnsOnViolation:
    ...
    def test_provider_emitting_wrapper_warns(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="brain.memory_manager"):
