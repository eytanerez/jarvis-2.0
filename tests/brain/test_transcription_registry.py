"""Tests for brain/transcription_registry.py and brain/transcription_provider.py.
...
from brain import transcription_registry
...
class TestRegistration:
    ...
    def test_rejects_builtin_shadow_with_warning(self, builtin, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="brain.transcription_registry"):
            transcription_registry.register_provider(p)
    ...
    def test_reregistration_overwrites(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="brain.transcription_registry"):
...
class TestBuiltinSync:
    """``_BUILTIN_NAMES`` in brain/transcription_registry.py is duplicated
    ...
    def test_registry_builtins_match_dispatcher_builtins(self):
        ...
        assert transcription_registry._BUILTIN_NAMES == BUILTIN_STT_PROVIDERS, (
            "brain.transcription_registry._BUILTIN_NAMES and "
