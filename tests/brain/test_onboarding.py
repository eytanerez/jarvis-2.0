"""Tests for brain/onboarding.py — contextual first-touch hint helpers."""
...
class TestProfileBuildMode:
    def test_default_is_ask(self):
        from brain.onboarding import profile_build_mode
...
class TestProfileBuildDirective:
    def test_directive_is_opt_in_and_consent_gated(self):
        from brain.onboarding import profile_build_directive
...
class TestProfileBuildSeenFlag:
    def test_flag_round_trips(self, tmp_path):
        from brain.onboarding import PROFILE_BUILD_FLAG
