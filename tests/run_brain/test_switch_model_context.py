...
def _make_agent_with_compressor(config_context_length=None) -> AIBrain:
...
def test_switch_model_without_config_context_length():
    ...
    with patch("brain.model_metadata.get_model_context_length", return_value=128_000) as mock_ctx_len:
        # Switch model
        agent.switch_model("new-model", "openrouter", api_key="sk-new", base_url="https://openrouter.ai/api/v1")
