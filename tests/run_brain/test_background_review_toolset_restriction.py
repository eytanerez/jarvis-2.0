...
def _make_agent_stub(agent_cls):
    """Create a minimal AIBrain-like object with just enough state for _spawn_background_review."""
...
def test_background_review_matches_parent_toolset_config():
    ...
    agent = _make_agent_stub(run_brain.AIBrain)
    captured = {}
    ...
    with patch.object(run_brain.AIBrain, "__init__", _capture_init), \
    ...
    assert "enabled_toolsets" in captured, "AIBrain.__init__ was not called"
...
def test_background_review_installs_thread_local_whitelist():
    ...
    def _no_init(self, *args, **kwargs):
        # Don't crash AIBrain.__init__; let execution flow reach
        # set_thread_tool_whitelist.
        return None

    with patch.object(run_brain.AIBrain, "__init__", _no_init), \
