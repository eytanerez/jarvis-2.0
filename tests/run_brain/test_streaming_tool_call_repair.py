...
The streaming path (run_brain._call_chat_completions) assembles tool call
...
from run_brain import _repair_tool_call_arguments
...
class TestStreamingAssemblyRepair:
    ...
    exercise the full streaming path are in run_brain.py's streaming tests.
    """
