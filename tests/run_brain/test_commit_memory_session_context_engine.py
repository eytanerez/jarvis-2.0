"""Regression tests for AIBrain.commit_memory_session.
...
def _make_minimal_agent(memory_manager, context_compressor, session_id="abc"):
    ...
    AIBrain.__init__ is too heavy for a focused unit test — bind the method
    ...
    obj.commit_memory_session = AIBrain.commit_memory_session.__get__(obj)
    return obj
