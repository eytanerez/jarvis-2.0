...
def _make_minimal_agent() -> AIBrain:
    """Return an AIBrain constructed with the absolute minimum args.
    ...
    """
    agent = AIBrain.__new__(AIBrain)  # skip __init__ entirely
