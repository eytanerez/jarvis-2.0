...
from brain.conversation_loop import _get_continuation_prompt
...
class TestPartialStreamStubFinishReason:
    ...
    def test_text_only_partial_returns_length(self, _mock_close, mock_create, monkeypatch):
        ...
        monkeypatch.setenv("JARVIS_STREAM_RETRIES", "0")
...
@pytest.fixture()
def loop_agent():
    """AIBrain with a mocked OpenAI client (mirrors test_run_brain's fixture)
...
class TestConversationLoopPartialStreamContinuation:
    ...
    def test_partial_stream_stub_does_not_exit_loop_immediately(self, loop_agent):
        ...
        from tests.run_brain.test_run_brain import _mock_response, _mock_assistant_msg
