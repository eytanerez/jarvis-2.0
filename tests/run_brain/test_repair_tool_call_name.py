"""Tests for AIBrain._repair_tool_call — tool-name normalization.
...
def repair():
    ...
    We avoid constructing a real AIBrain (which pulls in credential
    ...
    return AIBrain._repair_tool_call.__get__(stub, AIBrain)
