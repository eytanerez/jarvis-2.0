"""Tests for AIBrain.steer() — mid-run user message injection.
...
from brain.prompt_builder import STEER_MARKER_OPEN, format_steer_marker
from run_brain import AIBrain


def _bare_agent() -> AIBrain:
    """Build an AIBrain without running __init__, then install the steer
...
class TestSteerMarkerContract:
    def test_system_prompt_note_describes_the_real_marker(self):
        ...
        from brain.prompt_builder import STEER_CHANNEL_NOTE, STEER_MARKER_CLOSE
...
class TestSteerCommandRegistry:
    ...
    def test_steer_in_bypass_set(self):
        ...
        """
        from jarvis_cli.commands import ACTIVE_SESSION_BYPASS_COMMANDS, should_bypass_active_session
