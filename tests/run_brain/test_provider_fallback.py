...
from run_brain import AIBrain, _pool_may_recover_from_rate_limit
...
class TestFallbackChainAdvancement:
    ...
    def test_advances_index(self):
        ...
        agent = _make_agent(fallback_model=fbs)
        with patch("brain.auxiliary_client.resolve_provider_client",
    ...
    def test_skips_unconfigured_provider_to_next(self):
        ...
        agent = _make_agent(fallback_model=fbs)
        with patch("brain.auxiliary_client.resolve_provider_client") as mock_rpc:
...
class TestFallbackChainDedup:
    ...
    def test_skips_entry_matching_current_provider_and_model(self):
        ...
        with patch("brain.auxiliary_client.resolve_provider_client", side_effect=_resolve):
    ...
    def test_returns_false_when_only_self_matching_entries(self):
        ...
        with patch("brain.auxiliary_client.resolve_provider_client") as mock_resolve:
            ok = agent._try_activate_fallback()
