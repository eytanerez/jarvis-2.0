...
Run directly to see a human-readable report:
    ...
    python tests/run_brain/repro_48013_image_shrink_brick.py

Or as a pytest smoke test (skipped automatically when Pillow is absent):

    scripts/run_tests.sh tests/run_brain/repro_48013_image_shrink_brick.py
"""
...
from brain.conversation_compression import (  # noqa: E402
