...
from brain.context_compressor import ContextCompressor, _CHARS_PER_TOKEN
...
def _make_compressor(**kwargs) -> ContextCompressor:
    ...
    with patch("brain.context_compressor.get_model_context_length", return_value=96000):
