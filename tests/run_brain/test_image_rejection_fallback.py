"""Tests for the image-rejection fallback in run_brain.
...
from run_brain import _strip_images_from_messages
...
class TestImageRejectionPhraseIsolation:
    ...
    # Reproduces the phrase list used in run_brain.py's error-handler block.
    _REJECTION_PHRASES = (
    ...
    def test_anthropic_image_too_large_does_not_trip(self):
        # From brain/error_classifier.py _IMAGE_TOO_LARGE_PATTERNS —
