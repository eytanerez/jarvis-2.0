...
``role: "tool"`` messages (Xiaomi MiMo's 400 "text is not set", etc.):
  ...
  1. brain/error_classifier.py: 400 with the right wording classifies as
     ``FailoverReason.multimodal_tool_content_unsupported``.
  2. run_brain._try_strip_image_parts_from_tool_messages downgrades tool
  ...
  3. run_brain._tool_result_content_for_active_model short-circuits to a
...
See: https://github.com/NousResearch/jarvis-brain/issues/27344
"""
...
def _make_agent(provider: str = "xiaomi", model: str = "mimo-v2.5"):
    """Build a bare AIBrain for method-level testing, no provider setup."""
