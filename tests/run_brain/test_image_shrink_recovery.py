...
future provider that returns an image-too-large error):
  ...
  1. brain/error_classifier.py: 400 with "image exceeds 5 MB maximum"
     gets FailoverReason.image_too_large, not context_overflow.
  2. run_brain._try_shrink_image_parts_in_messages mutates the API
...
from brain.conversation_loop import _image_error_max_dimension
