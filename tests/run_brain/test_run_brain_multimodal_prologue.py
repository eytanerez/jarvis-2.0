...
``run_brain.run_conversation`` because the prologue unconditionally called
...
They do NOT boot the full AIBrain — the prologue-fix guarantees are pure
function contracts at module scope.
"""

from run_brain import _summarize_user_message_for_log
from brain.codex_responses_adapter import _chat_content_to_responses_parts
