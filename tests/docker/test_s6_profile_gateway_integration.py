...
The unit tests in tests/jarvis_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned jarvis-writable by the
...
from jarvis_cli.service_manager import S6ServiceManager
