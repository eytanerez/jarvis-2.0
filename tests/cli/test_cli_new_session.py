...
class _FakeAgent:
    ...
    def reset_session_state(self):
        """Mirror the real AIBrain.reset_session_state()."""
...
def test_new_command_rotates_jarvis_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["JARVIS_SESSION_ID"] == cli.session_id
    assert get_session_env("JARVIS_SESSION_ID") == cli.session_id
