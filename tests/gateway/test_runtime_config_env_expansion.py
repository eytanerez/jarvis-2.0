...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("JARVIS_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("JARVIS_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("JARVIS_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
