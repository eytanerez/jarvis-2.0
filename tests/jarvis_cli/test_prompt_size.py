"""Tests for the ``jarvis prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from jarvis_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(jarvis_home, memory_text="", user_text=""):
    mem_dir = jarvis_home / "memories"
...
def _seed_skill(jarvis_home, name, description):
    skill_dir = jarvis_home / "skills" / "demo" / name
