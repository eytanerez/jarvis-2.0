...
The main() function in jarvis_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `jarvis -c model`
...
def _build_parser():
    """Build a minimal replica of the jarvis top-level parser."""
