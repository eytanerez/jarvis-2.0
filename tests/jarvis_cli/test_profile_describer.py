...
from jarvis_cli import profile_describer as describer


@pytest.fixture
def profile_env(tmp_path, monkeypatch):
    """Set up an isolated JARVIS_HOME with a default profile dir."""
...
def test_describer_writes_description_with_auto_true(profile_env, monkeypatch):
    ...
    with _patch_aux_client(payload), patch(
        "brain.auxiliary_client.get_auxiliary_extra_body", return_value={}
    ):
