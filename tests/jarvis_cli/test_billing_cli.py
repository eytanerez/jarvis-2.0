...
import brain.billing_view as bv
from brain.billing_view import BillingState, CardInfo, MonthlyCap
from cli import JarvisCLI


@pytest.fixture
def cli():
    obj = JarvisCLI.__new__(JarvisCLI)  # bypass __init__ (no full app needed)
