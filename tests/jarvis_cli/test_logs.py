"""Tests for jarvis_cli.logs — log viewing and filtering."""

from datetime import datetime, timedelta


from jarvis_cli.logs import (
    LOG_FILES,
    _extract_level,
...
class TestExtractLevel:
    ...
    def test_error(self):
        assert _extract_level("2026-01-01 00:00:00 ERROR run_brain: msg") == "ERROR"
...
class TestExtractLoggerName:
    ...
    def test_top_level_module(self):
        line = "2026-04-11 10:23:45 INFO run_brain: starting conversation"
        assert _extract_logger_name(line) == "run_brain"
