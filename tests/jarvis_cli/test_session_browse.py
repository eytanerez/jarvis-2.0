"""Tests for the interactive session browser (`jarvis sessions browse`).
...
from jarvis_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """jarvis sessions browse should be parseable."""
