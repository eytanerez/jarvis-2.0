...
class TestXiaomiModelCatalog:
    ...
    def test_models_dev_mapping(self):
        from brain.models_dev import PROVIDER_TO_MODELS_DEV
    ...
    def test_list_agentic_models_mock(self, monkeypatch):
        ...
        from brain import models_dev as md
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from jarvis_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in JARVIS_OVERLAYS
        overlay = JARVIS_OVERLAYS["xiaomi"]
...
class TestXiaomiAuxiliary:
    ...
    def test_vision_model_override(self):
        ...
        from brain.auxiliary_client import _PROVIDER_VISION_MODELS
...
class TestXiaomiDoctor:
    """Verify jarvis doctor recognizes Xiaomi env vars."""
...
class TestXiaomiAgentInit:
    ...
    def test_no_syntax_errors(self):
        """Importing run_brain with xiaomi should not raise."""
        import importlib
