...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from jarvis_cli.models import normalize_provider
...
# =============================================================================
# CANONICAL_PROVIDERS (jarvis model picker)
# =============================================================================
...
class TestTencentInOpenRouterAndNous:
    ...
    def test_in_openrouter_fallback(self):
        from jarvis_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from jarvis_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from jarvis_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in JARVIS_OVERLAYS
        overlay = JARVIS_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAuxiliary:
    ...
    def test_aux_model_registered(self):
        from brain.auxiliary_client import _API_KEY_PROVIDER_AUX_MODELS
    ...
    def test_aux_aliases(self):
        from brain.auxiliary_client import _PROVIDER_ALIASES
...
class TestTencentTokenhubDoctor:
    """Verify jarvis doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_no_syntax_errors(self):
        """Importing run_brain with tencent-tokenhub should not raise."""
        import importlib
        importlib.import_module("run_brain")

    def test_api_mode_is_chat_completions(self):
        from jarvis_cli.providers import JARVIS_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = JARVIS_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``jarvis model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from jarvis_cli import main as main_mod
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from jarvis_cli.models import _KNOWN_PROVIDER_NAMES
