...
def jarvis_home(tmp_path, monkeypatch):
    """Isolated JARVIS_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves JARVIS_HOME.
    from jarvis_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from jarvis_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from jarvis_cli.goals import judge_goal
    ...
    def test_no_aux_client_continues(self):
        ...
        with patch(
            "brain.auxiliary_client.get_text_auxiliary_client",
...
class TestGoalManager:
    def test_no_goal_initial(self, jarvis_home):
    ...
    def test_set_then_status(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_clear(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, jarvis_home):
    ...
    def test_evaluate_after_turn_done(self, jarvis_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, jarvis_home):
        from jarvis_cli import goals
        from jarvis_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, jarvis_home):
    ...
    def test_evaluate_after_turn_inactive(self, jarvis_home):
    ...
    def test_continuation_prompt_shape(self, jarvis_home):
        ...
        mgr.set("port goal command to jarvis")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to jarvis" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from jarvis_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, jarvis_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from jarvis_cli import goals
        from jarvis_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, jarvis_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, jarvis_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from jarvis_cli import goals
        from jarvis_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from jarvis_cli.goals import GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_add_subgoal_requires_active_goal(self, jarvis_home):
        import pytest
        from jarvis_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, jarvis_home):
        import pytest
        from jarvis_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, jarvis_home):
        import pytest
        from jarvis_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, jarvis_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, jarvis_home):
        ...
        with patch.object(goals, "get_text_auxiliary_client",
             ...
             patch("brain.auxiliary_client.get_text_auxiliary_client",
                   return_value=(_FakeClient, "fake-model")), \
             patch("brain.auxiliary_client.get_auxiliary_extra_body",
                   return_value=None):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, jarvis_home):
        from unittest.mock import patch
        from jarvis_cli import goals
        ...
        with patch("brain.auxiliary_client.get_text_auxiliary_client",
                   return_value=(_FakeClient, "fake-model")), \
             patch("brain.auxiliary_client.get_auxiliary_extra_body",
                   return_value=None):
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, jarvis_home):
        from jarvis_cli.goals import GoalManager
