"""Tests for the specifier module + `jarvis kanban specify` CLI surface.
...
from jarvis_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `jarvis kanban …` argparse surface directly."""
