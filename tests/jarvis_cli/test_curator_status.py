"""Tests for `jarvis curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    import brain.curator as curator_state
    import jarvis_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated JARVIS_HOME with real agent-created skills on disk."""
    ...
    from jarvis_cli import curator as curator_cli
