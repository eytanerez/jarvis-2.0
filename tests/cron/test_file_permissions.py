...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("jarvis_cli.config.get_config_path", return_value=config_path), \
             patch("jarvis_cli.config.ensure_jarvis_home"):
    ...
    def test_ensure_jarvis_home_sets_0700(self):
        home = Path(self.tmpdir) / ".jarvis"
