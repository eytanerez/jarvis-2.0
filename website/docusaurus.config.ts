...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/jarvis-brain/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/jarvis-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/jarvis-brain/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://jarvis-agent.nousresearch.com/' },
