...
| | |
|---|---|
| 来源 | 可选 — 使用 `jarvis skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Jarvis |
| 许可证 | MIT |
...
```
SCRIPT=~/.jarvis/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.jarvis/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
