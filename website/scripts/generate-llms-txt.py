#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Jarvis docs site.
...
Both publish at:
  https://jarvis-agent.nousresearch.com/docs/llms.txt
  https://jarvis-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://jarvis-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Jarvis as a Python Library", None),
        ("guides/use-mcp-with-jarvis", "Use MCP with Jarvis", None),
        ("guides/use-voice-mode-with-jarvis", "Use Voice Mode with Jarvis", None),
        ("guides/use-soul-with-jarvis", "Use SOUL.md with Jarvis", None),
        ("guides/build-a-jarvis-plugin", "Build a Jarvis Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Jarvis"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "jarvis-brain/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/jarvis-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        (
            "This file is the entire Jarvis documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Jarvis, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://jarvis-agent.nousresearch.com/docs\n",
        "Short index: https://jarvis-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
