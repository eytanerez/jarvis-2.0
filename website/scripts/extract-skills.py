...
2. The unified Jarvis Skills Index at ``website/static/api/skills-index.json``,
...
def _source_url(source: str, identifier: str, extra: dict) -> str:
    ...
    if src == "lobehub":
        ...
        return f"https://lobehub.com/brain/{slug}"
