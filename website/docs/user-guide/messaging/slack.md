...
[`COMMAND_REGISTRY`](https://github.com/NousResearch/jarvis-brain/blob/main/jarvis_cli/commands.py)
...
Jarvis falls back to a text prompt, the prompt instructs you to reply
