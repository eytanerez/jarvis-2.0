...
Set your Tenor API key in your environment (add to `~/.jarvis/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/jarvis-brain/blob/main/skills/media/gif-search/url)`
