...
| Related skills | [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging), [`node-inspect-debugger`](/docs/user-guide/skills/bundled/software-development/software-development-node-inspect-debugger), [`debugging-jarvis-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-jarvis-tui-commands) |
...
The jarvis test runner and pytest both support this:
...
The easiest terminal-side DAP client is VS Code CLI or a small script. From inside Jarvis you have two practical options:
