...
| | |
|---|---|
| Source | Optional — install with `jarvis skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Jarvis"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.jarvis/.env`:
