...
| | |
|---|---|
| Source | Optional — install with `jarvis skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Jarvis (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $JARVIS_OSINT_CACHE/icij/ (default: ~/.cache/jarvis-osint/icij/).
...
# Set JARVIS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
