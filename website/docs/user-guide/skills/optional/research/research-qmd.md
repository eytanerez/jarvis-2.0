...
| | |
|---|---|
| Source | Optional — install with `jarvis skills install official/research/qmd` |
...
Jarvis via the native MCP client. This is the preferred
...
Then configure Jarvis to connect via HTTP:
