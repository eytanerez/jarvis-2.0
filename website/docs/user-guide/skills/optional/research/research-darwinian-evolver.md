...
| | |
|---|---|
| Source | Optional — install with `jarvis skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Jarvis |
| License | MIT |
...
import upstream classes into Jarvis itself.
...
Open `~/.jarvis/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Jarvis core.
   Custom driver scripts under `~/.jarvis/skills/...` are user-side and fine.
