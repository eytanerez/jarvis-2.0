...
| | |
|---|---|
| Source | Optional — install with `jarvis skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.jarvis/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.jarvis/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Jarvis installs package this)
