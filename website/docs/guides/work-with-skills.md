...
For how to ship skills in your own plugin, see [Build a Jarvis Plugin → Bundle skills](/guides/build-a-jarvis-plugin#bundle-skills).
...
jarvis config show | grep '^skills\.config'
```
