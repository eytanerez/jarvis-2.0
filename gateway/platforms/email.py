"""
Email platform adapter for the Jarvis gateway.

Allows users to interact with Jarvis by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Jarvis")
        ...
        msg_id = f"<jarvis-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
