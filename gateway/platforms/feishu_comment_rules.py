...
Config: ~/.jarvis/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.jarvis/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_jarvis_home()`` helper (JARVIS_HOME-aware and
