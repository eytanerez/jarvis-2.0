...
# Opt-in debug tracing — pairs with JARVIS_DEBUG_INTERRUPT in
...
if _DEBUG_INTERRUPT:
    # AIBrain's quiet_mode path forces `tools` logger to ERROR on CLI startup.
    # Force our own logger back to INFO so the trace is visible in brain.log.
