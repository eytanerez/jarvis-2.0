"""``jarvis tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'jarvis tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # jarvis tools list [--platform cli]
    ...
    # jarvis tools disable <name...> [--platform cli]
    ...
    # jarvis tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `jarvis tools` runs after you pick a provider that\n"
