...
Invoked by ``jarvis kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Jarvis board.
...
def _profile_author() -> str:
    """Mirror of ``jarvis_cli.kanban._profile_author``."""
    return (
