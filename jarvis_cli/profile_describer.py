...
Used by ``jarvis profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``jarvis_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Jarvis kanban board.
...
Rules:
  ...
  - Never write "Jarvis profile" or other meta-narration.
...
def describe_profile(
    ...
    *,
    ...
    try:
        from brain.auxiliary_client import (  # type: ignore
