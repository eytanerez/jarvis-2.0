...
Usage:
    jarvis pairing list              # Show all pending + approved users
    jarvis pairing approve <platform> <code>  # Approve a pairing code
    jarvis pairing revoke <platform> <user_id> # Revoke user access
    jarvis pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle jarvis pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: jarvis pairing {list|approve|revoke|clear-pending}")
        print("Run 'jarvis pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.jarvis/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'jarvis pairing list' to see pending codes.\n")
