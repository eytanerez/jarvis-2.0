...
Entry point: ``jarvis whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``jarvis_cli/main.py``).
...
Jarvis gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Jarvis to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Jarvis needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Jarvis gateway in another terminal:")
    ...
    print()
    print("  Docs: https://jarvis-agent.nousresearch.com/docs/user-guide/")
