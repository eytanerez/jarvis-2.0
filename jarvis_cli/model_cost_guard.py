...
class ExpensiveModelWarning:
    """Confirmation payload for models above Jarvis' cost guardrail."""
...
def expensive_model_warning(
    ...
    *,
    ...
    if input_cost is None and output_cost is None and provider:
        try:
            from brain.models_dev import get_model_info
    ...
    lines = [
        ...
        "",
        f"{model} has known pricing above Jarvis' safety threshold.",
