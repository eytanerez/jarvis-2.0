"""
Skills configuration for Jarvis.
`jarvis skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.jarvis/config.yaml under:
...
from jarvis_cli.config import cfg_get, load_config, save_config
from jarvis_cli.colors import Colors, color
from jarvis_cli.platforms import PLATFORMS as _PLATFORMS
