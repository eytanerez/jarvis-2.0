 ...
 *
 * Plugins call window.__JARVIS_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__JARVIS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__JARVIS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__JARVIS_PLUGIN_SDK__ = {
    ...
    // window.__JARVIS_SESSION_TOKEN__ directly.
    authedFetch,
