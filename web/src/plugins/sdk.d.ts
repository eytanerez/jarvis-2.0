/**
 * Jarvis Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__JARVIS_PLUGIN_SDK__`` and
 * ``window.__JARVIS_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__JARVIS_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``JarvisPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@jarvis/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__JARVIS_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__JARVIS_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__JARVIS_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __JARVIS_PLUGIN_SDK__?: JarvisPluginSDK;
    __JARVIS_PLUGINS__?: PluginRegistry;
  }
}
