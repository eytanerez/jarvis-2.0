 ...
 * `window.__JARVIS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Jarvis brand in the top bar
 ...
 *  `window.__JARVIS_PLUGINS__.registerSlot(...)`.
 *
