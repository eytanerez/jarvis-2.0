...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateJarvis: "Aggiorna Jarvis",
    updatingJarvis: "Aggiornamento di Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Jarvis (parità con `jarvis plugins`).",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.jarvis/skills/",
