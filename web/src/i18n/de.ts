...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateJarvis: "Jarvis aktualisieren",
    updatingJarvis: "Jarvis wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Jarvis-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `jarvis plugins`).",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.jarvis/skills/ geladen",
