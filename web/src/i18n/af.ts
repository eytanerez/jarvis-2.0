...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateJarvis: "Werk Jarvis op",
    updatingJarvis: "Besig om Jarvis op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Jarvis-inproppe op (`jarvis plugins` ekwivalent).",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.jarvis/skills/",
