...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateJarvis: "Jarvis 업데이트",
    updatingJarvis: "Jarvis 업데이트 중…",
  ...
  pluginsPage: {
    ...
    headline:
      "Jarvis 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`jarvis plugins` 동등).",
  ...
  skills: {
    ...
    categories: "카테고리",
    filters: "필터",
    noSkills: "스킬을 찾을 수 없습니다. 스킬은 ~/.jarvis/skills/ 에서 로드됩니다",
