...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateJarvis: "Nuashonraigh Jarvis",
    updatingJarvis: "Ag nuashonrú Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Jarvis (paireacht le `jarvis plugins`).",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.jarvis/skills/",
