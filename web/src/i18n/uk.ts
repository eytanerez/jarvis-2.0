...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateJarvis: "Оновити Jarvis",
    updatingJarvis: "Оновлення Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Jarvis (паритет з `jarvis plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.jarvis/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.jarvis/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.jarvis/skills/",
