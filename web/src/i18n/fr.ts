...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateJarvis: "Mettre à jour Jarvis",
    updatingJarvis: "Mise à jour de Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Jarvis (parité avec `jarvis plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.jarvis/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.jarvis/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.jarvis/skills/",
