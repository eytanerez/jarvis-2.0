...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Jarvis eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`jarvis plugins` ile eşdeğer).",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.jarvis/skills/ adresinden yüklenir",
