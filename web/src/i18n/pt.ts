...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateJarvis: "Atualizar Jarvis",
    updatingJarvis: "A atualizar Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Jarvis (paridade com `jarvis plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.jarvis/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.jarvis/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.jarvis/skills/",
