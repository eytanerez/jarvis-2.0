...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Jarvis-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `jarvis plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.jarvis/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.jarvis/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.jarvis/skills/ mappából töltődnek be",
