...
export const ja: Translations = {
  ...
  status: {
    ...
    updatingJarvis: "Jarvis を更新しています…",
  ...
  pluginsPage: {
    ...
    headline:
      "Jarvis プラグインを発見、インストール、有効化、更新します (`jarvis plugins` 相当)。",
    ...
    removeConfirm: "このプラグインを ~/.jarvis/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.jarvis/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.jarvis/skills/ から読み込まれます",
