...
export const en: Translations = {
  ...
  status: {
    ...
    updatingJarvis: "Updating Jarvis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Jarvis plugins (`jarvis plugins` parity).",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.jarvis/skills/",
