 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `jarvis_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" Jarvis look, ported from the
 ...
 * nousnet-web's <body> is white; jarvis-agent's App root is `bg-black`,
