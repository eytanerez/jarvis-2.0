...
const STORAGE_KEY = "jarvis-dashboard-theme";
...
const FONT_STORAGE_KEY = "jarvis-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `jarvis_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "jarvis-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-jarvis-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-jarvis-theme-font", "true");
