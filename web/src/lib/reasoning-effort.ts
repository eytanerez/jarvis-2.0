 ...
 *
 * Values mirror jarvis_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Jarvis default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Jarvis' default when unset). */
