...
import { launchJarvisDesktop } from '../store'
import { Rocket, AlertCircle } from 'lucide-react'

/*
 * Success screen. JARVIS AGENT wordmark stays as the visual anchor
 ...
 * Jarvis.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchJarvisDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="jarvis-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          ...
          <span aria-hidden="true">Jarvis is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Jarvis'}
      </Button>
