...
final class FullDiskAccessPermissionStore: ObservableObject {
    ...
    func requestAccessPrompt() {
        ...
        alert.informativeText = "Jarvis Notch needs Full Disk Access to detect custom Focus indicators and power the Shelf. Click Continue to open Full Disk Access settings, then press the + button and select Jarvis Notch (we'll reveal it in Finder for you)."
