...
struct ExtensionsSettingsView: View {
    ...
    private var globalTogglesSection: some View {
        Section {
            ...
            if Defaults[.enableThirdPartyExtensions] {
                Text("Third-party apps using the notch extension SDK can display live activities, lock screen widgets, and dedicated notch experiences. Toggle features above or manage individual app permissions below.")
                    .font(.caption)
        ...
        Section {
            if authManager.entries.isEmpty {
                VStack(alignment: .center, spacing: 12) {
                    ...
                    Text("Apps using the notch extension SDK will appear here once they request permission")
                        .font(.caption)
                        .foregroundStyle(.secondary)
