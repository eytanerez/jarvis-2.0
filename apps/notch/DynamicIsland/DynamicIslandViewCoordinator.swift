...
class DynamicIslandViewCoordinator: ObservableObject {
    ...
    private static let tabOrder: [NotchViews] = [.home, .jarvis, .shelf, .timer, .stats, .colorPicker, .notes, .clipboard, .terminal, .extensionExperience]
    ...
    @Published var currentView: NotchViews = .home {
        didSet {
            if Defaults[.enableMinimalisticUI] && currentView != .home && currentView != .jarvis {
                currentView = .home
                return
            }
