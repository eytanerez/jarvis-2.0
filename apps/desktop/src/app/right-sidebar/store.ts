...
const TAKEOVER_KEY = 'jarvis.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Jarvis can't clear via the API — the user
 *  sees exactly what runs instead of Jarvis silently deleting their creds. */
