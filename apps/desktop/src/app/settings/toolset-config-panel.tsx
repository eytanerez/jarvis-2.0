...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/jarvis'
 ...
 * log inline — the GUI equivalent of the install step `jarvis tools` runs
