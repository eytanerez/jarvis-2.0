...
import { getJarvisConfigRecord, type JarvisGateway, saveJarvisConfig } from '@/jarvis'
...
function getServers(config: JarvisConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveJarvisConfig(nextConfig)
