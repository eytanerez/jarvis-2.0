...
import { $cockpitMode, setCockpitMode } from '@/store/jarvis-cockpit'
...
export function ChatView({
  ...
  const { t } = useI18n()
  const cockpitMode = useStore($cockpitMode)
  ...
  // The J.A.R.V.I.S orb replaces the scrolling thread as the default surface;
