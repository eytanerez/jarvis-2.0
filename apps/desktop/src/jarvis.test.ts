...
import { getSessionMessages, listAllProfileSessions, listSessions } from './jarvis'
...
describe('Jarvis REST session helpers', () => {
  ...
  afterEach(() => {
    vi.restoreAllMocks()
    Reflect.deleteProperty(window, 'jarvisDesktop')
  })
