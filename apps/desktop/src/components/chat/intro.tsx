...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Jarvis look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Jarvis need to see?`,
    ...
    {
      headline: `What should ${label} Jarvis tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-[family-name:var(--dt-font-sans)] font-bold uppercase leading-[0.9] tracking-[0.08em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
