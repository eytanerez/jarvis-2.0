    ...
    return (
      <a
        ...
        onClick={event => {
          ...
          void window.jarvisDesktop?.openExternal(mediaExternalUrl(image))
        }}
      >
  ...
  return (
    <>
      <span
        ...
        className="group/image relative block max-w-full overflow-hidden rounded-lg transition-[width,height] duration-300 ease-out"
