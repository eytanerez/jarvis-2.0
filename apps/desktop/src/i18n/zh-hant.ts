...
export const zhHant = defineLocale({
  jarvis: {
    ...
    model: '模型',
    session: '工作階段',
    sessionActive: '工作階段進行中',
    newSession: '新增工作階段',
    textMode: '文字模式',
    orbMode: '光球模式',
    classicHint: '切換至經典聊天串',
    orbHint: '切換至 J.A.R.V.I.S 光球',
    emptyPrompt: '開始說話或輸入。',
    interrupt: '停止',
    toolActivity: '工具活動',
    menu: {
  ...
  boot: {
    ready: 'Jarvis Desktop 已就緒',
    desktopBootFailedWithMessage: message => `桌面啟動失敗：${message}`,
    steps: {
      connectingGateway: '正在連線桌面閘道',
      loadingSettings: '正在載入 Jarvis 設定',
      loadingSessions: '正在載入最近工作階段',
      startingDesktopConnection: '正在啟動桌面連線',
      startingJarvisDesktop: '正在啟動 Jarvis Desktop…'
    },
    errors: {
      backgroundExited: 'Jarvis 背景程序已結束。',
      backgroundExitedDuringStartup: 'Jarvis 背景程序在啟動期間結束。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '您的 Jarvis 後端早於目前的桌面版本，可能無法正常運作。請更新以保持一致。',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 Jarvis Desktop。',
  ...
  settings: {
    ...
    resetConfirm: '要將所有設定恢復為 Jarvis 預設值嗎？',
    exportFailed: '匯出失敗',
    resetFailed: '重設失敗',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒僅在 Jarvis 位於背景時觸發。',
      kinds: {
        approval: {
          label: '需要核准',
        ...
        input: {
          label: '需要輸入',
          description: 'Jarvis 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
          description: 'Jarvis 在背景時完成了一輪對話。'
        },
        turnError: {
          label: '本輪失敗',
          description: '本輪以錯誤結束。'
    ...
    appearance: {
      ...
      colorMode: '色彩模式',
      colorModeDesc: '選擇固定模式，或讓 Jarvis 跟隨系統設定。',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Jarvis 需要本機時間上下文時使用。留空則使用系統時區。',
      agent: {
        imageInputMode: '控制圖片附件如何傳送給模型。',
        maxTurns: 'Jarvis 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'Jarvis 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'Jarvis 如何處理需要明確批准的指令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Jarvis 從應用程式內更新自身時，保留本機原始碼變更（stash）或丟棄（discard）。終端機更新一律會詢問。'
      }
    }),
    notch: {
      title: "劉海螢幕",
      subtitle: "原生劉海螢幕設定由 Jarvis Notch 管理。此處的變更會傳送到配套應用程式並儲存在其 UserDefaults 中。",
      connected: "已連線",
      offline: "離線",
      restart: "重新啟動",
      restarting: "正在重新啟動 Jarvis Notch…",
      restartFailed: "無法重新啟動 Jarvis Notch",
      offlineToast: "Jarvis Notch 處於離線狀態。",
      loading: "正在載入劉海螢幕設定...",
      offlineBannerBefore: "Jarvis Notch 未連線。請使用以下命令建置：",
      offlineBannerAfter: "，然後重新啟動 Jarvis Desktop 即可編輯這些設定。",
      settingSaveFailed: "無法儲存劉海螢幕設定",
      settingsLoadFailed: "劉海螢幕設定載入失敗",
      permissionRequested: label => `已請求${label}。`,
      permissionRequestFailed: label => `無法請求${label}`,
      startup: {
        title: "啟動",
        launchAtLoginTitle: "登入時啟動 Jarvis",
        launchAtLoginDescription: "登入時自動啟動 Jarvis（及劉海螢幕），讓它隨時待命。",
        launchAtLoginUnsupported: "此平台不支援此功能。",
        launchAtLoginSaveFailed: "無法更新登入項目。",
        launchAtLoginError: "無法更新登入啟動設定"
      },
      permissions: {
        title: "權限",
        empty: "尚未回報任何權限狀態。",
      ...
      labels: {
        ...
        minimumHoverDuration: "懸停延遲",
        openNotchOnHover: "懸停時展開",
        extendHoverArea: "擴大懸停感應區域",
        hideNonNotchUntilHover: "懸停前隱藏外接顯示器藥丸列",
        externalDisplayStyle: "外接顯示器樣式",
        openNotchWidth: "展開時劉海螢幕寬度",
        notchHeight: "劉海螢幕顯示高度",
        nonNotchHeight: "外接顯示器高度",
        enableMinimalisticUI: "簡約介面",
        showEmojis: "表情符號點綴",
        settingsIconInNotch: "劉海螢幕內的設定圖示",
        lightingEffect: "光影效果",
        enableShadow: "視窗陰影",
        cornerRadiusScaling: "縮放圓角半徑",
        useModernCloseAnimation: "現代化關閉動畫",
        tileShowLabels: "圖磚標籤",
        showStandardMediaControls: "媒體控制分頁",
        autoHideInactiveNotchMediaPlayer: "無播放時自動隱藏播放器",
        mediaController: "媒體控制器",
        coloredSpectrogram: "封面配色視覺化",
        enableRealTimeWaveform: "即時波形",
        useMusicVisualizer: "音樂視覺化",
        enableLyrics: "歌詞",
        showLiveCanvasInDynamicIsland: "即時 Canvas 畫面",
        enableFullscreenMediaDetection: "全螢幕媒體偵測",
        enableSneakPeek: "換曲預覽提示",
        sneakPeekStyles: "預覽提示樣式",
        showSneakPeekOnTrackChange: "換曲時顯示預覽提示",
        showShuffleAndRepeat: "隨機播放與循環控制",
        showMediaOutputControl: "媒體輸出控制",
        musicSkipBehavior: "跳過行為",
        musicControlWindowEnabled: "浮動音樂控制器",
        inlineHUD: "內嵌 HUD",
        progressBarStyle: "進度條樣式",
        showProgressPercentages: "顯示百分比",
        systemEventIndicatorShadow: "指示器陰影",
        systemEventIndicatorUseAccent: "使用主題強調色",
        showSongMetadataInClosedNotch: "閉合狀態下顯示曲目資訊",
        enableReminderLiveActivity: "提醒事項即時動態",
        reminderLeadTime: "提醒提前時間",
        reminderSneakPeekDuration: "提醒預覽顯示秒數",
        reminderPresentationStyle: "提醒樣式",
        enableLockScreenLiveActivity: "鎖定畫面即時動態",
        enableLockSounds: "鎖定音效",
        enableLockScreenWeatherWidget: "天氣小工具",
        enableLockScreenFocusWidget: "專注模式小工具",
        enableLockScreenReminderWidget: "提醒事項小工具",
        enableLockScreenTimerWidget: "計時器小工具",
        lockScreenWeatherShowsLocation: "顯示天氣位置",
        lockScreenWeatherShowsSunrise: "日出與日落",
        lockScreenWeatherShowsAQI: "空氣品質",
        lockScreenShowCalendarEvent: "行事曆事件",
        lockScreenShowCalendarCountdown: "行事曆倒數",
        lockScreenShowCalendarTimeRemaining: "剩餘時間",
        lockScreenCalendarEventLookaheadWindow: "行事曆預覽時間範圍",
        lockScreenWeatherVerticalOffset: "天氣垂直偏移",
        lockScreenTimerVerticalOffset: "計時器垂直偏移",
        lockScreenTimerWidgetWidth: "計時器小工具寬度",
        showMirror: "攝影機鏡像",
        selectedCameraID: "所選攝影機 ID",
        enableCameraDetection: "攝影機隱私指示器",
        enableMicrophoneDetection: "麥克風隱私指示器",
        showBluetoothDeviceConnections: "藍牙連線 HUD",
        useColorCodedBatteryDisplay: "彩色電量顯示",
        useColorCodedVolumeDisplay: "彩色音量顯示",
        useSmoothColorGradient: "平滑顏色漸層",
        useCircularBluetoothBatteryIndicator: "圓形電量指示器",
        showBluetoothBatteryPercentageText: "電量百分比文字",
        showBluetoothDeviceNameMarquee: "裝置名稱跑馬燈",
        useBluetoothHUD3DIcon: "3D 裝置圖示",
        enableSystemHUD: "取代系統 HUD",
        enableVolumeHUD: "音量 HUD",
        enableBrightnessHUD: "亮度 HUD",
        enableKeyboardBacklightHUD: "鍵盤背光 HUD",
        systemHUDSensitivity: "HUD 靈敏度",
        playVolumeChangeFeedback: "音量回饋音效",
        volumeStepPercent: "音量步進百分比",
        brightnessStepPercent: "亮度步進百分比",
        enableCustomOSD: "自訂 OSD 視窗",
        enableVerticalHUD: "垂直 HUD",
        enableCircularHUD: "圓形 HUD",
        verticalHUDPosition: "垂直 HUD 位置",
        verticalHUDShowValue: "垂直 HUD 數值",
        verticalHUDInteractive: "可互動垂直 HUD",
        verticalHUDHeight: "垂直 HUD 高度",
        circularHUDSize: "圓形 HUD 大小",
        showPowerStatusNotifications: "電源通知",
        showBatteryIndicator: "電量指示器",
        showBatteryPercentage: "電量百分比",
        showBatteryPercentInside: "在指示器內顯示百分比",
        showPowerStatusIcons: "電源狀態圖示",
        playLowBatteryAlertSound: "低電量提示音",
        showChargingBatteryHUD: "充電 HUD",
        showLowBatteryHUD: "低電量 HUD",
        showFullBatteryHUD: "滿電 HUD",
        lowBatteryHUDThreshold: "低電量閾值",
        fullBatteryHUDThreshold: "滿電閾值",
        lowBatteryHUDStyle: "低電量 HUD 樣式",
        fullBatteryHUDStyle: "滿電 HUD 樣式",
        enableTimerFeature: "計時器分頁",
        timerDisplayMode: "顯示模式",
        showTimerPresetsInNotchTab: "預設按鈕",
        timerIconColorMode: "圖示顏色",
        timerShowsCountdown: "倒數文字",
        timerShowsLabel: "計時器標籤",
        timerShowsProgress: "進度指示器",
        timerProgressStyle: "進度樣式",
        mirrorSystemTimer: "同步 macOS 時鐘計時器",
        timerControlWindowEnabled: "浮動計時器控制",
        showCalendar: "行事曆分頁",
        hideCompletedReminders: "隱藏已完成的提醒事項",
        hideAllDayEvents: "隱藏全天事件",
        showFullEventTitles: "顯示完整事件標題",
        autoScrollToNextEvent: "自動捲動到下一個事件",
        enableThirdPartyCalendarApp: "在第三方應用程式中開啟事件",
        selectedCalendarApp: "行事曆應用程式",
        fantasticalDefaultView: "Fantastical 檢視",
        enableNotes: "備忘錄分頁",
        enableNotePinning: "釘選備忘錄",
        enableNoteSearch: "搜尋備忘錄",
        enableNoteColorFiltering: "依顏色篩選",
        enableCreateFromClipboard: "從剪貼簿建立",
        enableNoteCharCount: "字數統計",
        enableClipboardManager: "剪貼簿管理員",
        clipboardHistorySize: "歷史記錄數量",
        showClipboardIcon: "剪貼簿圖示",
        clipboardDisplayMode: "顯示模式",
        enableColorPickerFeature: "取色器",
        showColorFormats: "顯示顏色格式",
        showColorPickerIcon: "取色器圖示",
        colorHistorySize: "歷史記錄數量",
        colorPickerDisplayMode: "顯示模式",
        enableDownloadListener: "下載監聽",
        enableSafariDownloads: "Safari 下載",
        selectedDownloadIndicatorStyle: "指示器樣式",
        selectedDownloadIconStyle: "圖示樣式",
        dynamicShelf: "檔案架分頁",
        openShelfByDefault: "預設開啟檔案架",
        quickShareProvider: "快速共享方式",
        localSendSelectedDeviceID: "LocalSend 裝置 ID",
        copyOnDrag: "拖曳時複製",
        autoRemoveShelfItems: "自動移除檔案架項目",
        expandedDragDetection: "擴大拖放感應區域",
        enableShortcuts: "鍵盤快捷鍵",
        enableGestures: "觸控板手勢",
        closeGestureEnabled: "關閉手勢",
        gestureSensitivity: "手勢靈敏度",
        enableHorizontalMusicGestures: "橫向音樂手勢",
        reverseSwipeGestures: "反轉滑動手勢",
        reverseScrollGestures: "反轉捲動手勢",
        enableStatsFeature: "統計分頁",
        autoStartStatsMonitoring: "自動開始監控",
        statsStopWhenNotchCloses: "劉海螢幕關閉時停止",
        statsUpdateInterval: "更新間隔",
        showCpuGraph: "CPU 圖表",
        showMemoryGraph: "記憶體圖表",
        showGpuGraph: "GPU 圖表",
        showNetworkGraph: "網路圖表",
        showDiskGraph: "磁碟圖表",
        enableTerminalFeature: "終端機分頁",
        terminalShellPath: "Shell 路徑",
        terminalFontFamily: "字型",
        terminalFontSize: "字型大小",
        terminalOpacity: "不透明度",
        terminalMaxHeightFraction: "最大高度比例",
        terminalCursorStyle: "游標樣式",
        terminalScrollbackLines: "回捲緩衝行數",
        terminalOptionAsMeta: "將 Option 鍵作為 Meta 鍵",
        terminalMouseReporting: "滑鼠事件回報",
        terminalBoldAsBright: "粗體顯示為高亮色",
        terminalStickyMode: "常駐模式",
        enableThirdPartyExtensions: "第三方擴充功能",
        enableExtensionLiveActivities: "即時動態",
        enableExtensionLockScreenWidgets: "鎖定畫面小工具",
        enableExtensionNotchExperiences: "劉海螢幕體驗",
        enableExtensionNotchTabs: "擴充功能分頁",
        enableExtensionNotchMinimalisticOverrides: "簡約模式覆寫",
        enableExtensionNotchInteractiveWebViews: "可互動網頁檢視",
        enableExtensionFileSharing: "檔案共享",
        extensionDiagnosticsLoggingEnabled: "診斷日誌",
        extensionLiveActivityCapacity: "即時動態數量上限",
        extensionLockScreenWidgetCapacity: "小工具數量上限",
        extensionNotchExperienceCapacity: "體驗數量上限",
      },
      optionLabels: {
        ...
        "sneakPeekStyles:Default": "預設",
        "sneakPeekStyles:Inline": "內嵌",
        "musicSkipBehavior:track": "跳過整曲",
        "musicSkipBehavior:tenSecond": "跳過十秒",
        "progressBarStyle:Hierarchical": "分層",
        "progressBarStyle:Gradient": "漸層",
        "progressBarStyle:Segmented": "分段",
        "reminderPresentationStyle:Ring": "環形",
        "reminderPresentationStyle:Digital": "數字",
        "reminderPresentationStyle:Minutes": "分鐘數",
        "verticalHUDPosition:left": "左",
        "verticalHUDPosition:right": "右",
        "lowBatteryHUDStyle:standard": "標準",
        "lowBatteryHUDStyle:compact": "精簡",
        "fullBatteryHUDStyle:standard": "標準",
        "fullBatteryHUDStyle:compact": "精簡",
        "timerDisplayMode:tab": "分頁",
        "timerDisplayMode:popover": "彈出視窗",
        "timerIconColorMode:Adaptive": "自適應",
        "timerIconColorMode:Solid": "純色",
        "timerProgressStyle:Bar": "進度條",
        "timerProgressStyle:Ring": "環形",
        "selectedCalendarApp:fantastical": "Fantastical",
        "selectedCalendarApp:notionCalendar": "Notion Calendar",
        "fantasticalDefaultView:mini": "迷你檢視",
        "fantasticalDefaultView:calendar": "行事曆檢視",
        "clipboardDisplayMode:popover": "彈出視窗",
        "clipboardDisplayMode:panel": "面板",
        "clipboardDisplayMode:separateTab": "獨立分頁",
        "colorPickerDisplayMode:popover": "彈出視窗",
        "colorPickerDisplayMode:panel": "面板",
        "selectedDownloadIndicatorStyle:Progress": "進度",
        "selectedDownloadIndicatorStyle:Percentage": "百分比",
        "selectedDownloadIndicatorStyle:Circle": "圓形",
        "selectedDownloadIconStyle:Only app icon": "僅應用程式圖示",
        "selectedDownloadIconStyle:Only download icon": "僅下載圖示",
        "selectedDownloadIconStyle:Icon and app icon": "圖示與應用程式圖示",
        "terminalCursorStyle:blinkBlock": "閃爍方塊",
        "terminalCursorStyle:block": "方塊",
        "terminalCursorStyle:underline": "底線",
        "terminalCursorStyle:bar": "豎線",
      }
    },
    about: {
      ...
      automaticUpdatesDesc: 'Jarvis 會在背景自動檢查更新，並在有可用更新時通知你。',
      branchCommit: (branch, commit) => `分支 ${branch} · 提交 ${commit}`,
      terminalUpdate: '終端機命令',
      terminalUpdateDesc: '開啟桌面終端機，並從此 checkout 執行 CLI 更新程式。',
      runJarvisUpdate: '執行 jarvis update',
      runJarvisUpdateToast: '正在終端機中執行 jarvis update...',
      terminalUnavailable: '終端機無法使用',
      never: '從未',
      justNow: '剛剛',
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Jarvis Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Jarvis 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      envOverrideDesc: '取消設定 JARVIS_DESKTOP_REMOTE_URL 和 JARVIS_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
      localDesc: '在 localhost 啟動私有 Jarvis 後端。這是預設方式，可離線使用。',
      remoteTitle: '遠端閘道',
      remoteDesc:
        '將此桌面殼層連線至遠端 Jarvis 後端。託管閘道使用 OAuth 或帳號密碼；自託管閘道也可使用工作階段 Token。',
      remoteUrlTitle: '遠端 URL',
      remoteUrlDesc: '遠端儀表板後端的基礎 URL。支援路徑前綴，例如 /jarvis。',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'Jarvis Desktop 將使用已儲存的設定重新連線。',
      savedMessage: '已儲存，下次重新啟動後生效。',
      connectedTo: (baseUrl, version) => `已連線至 ${baseUrl}${version ? ` · Jarvis ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: '使用訂閱登入，無需複製 API 金鑰。Jarvis 會在應用程式中為您完成瀏覽器登入。',
      connected: '已連線',
      collapse: '收合',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: '設定', detail: '設定 Jarvis 桌面端' },
    ...
    jarvisActiveSessions: (version, count) => `Jarvis ${version} · 活躍工作階段 ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 使用者 ID', placeholder: '@jarvis:example.org' },
  ...
  profiles: {
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 Jarvis 環境：各自擁有獨立的設定、技能和 SOUL.md。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。Jarvis 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  composer: {
    ...
    placeholderStarting: '正在啟動 Jarvis...',
    placeholderReconnecting: '正在重新連線至 Jarvis…',
    ...
    attachUrlDesc: 'Jarvis 將擷取該頁面並作為此回合的脈絡。',
  ...
  install: {
    ...
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 Jarvis CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 Jarvis 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
    activeDesc: '這是一次性設定。Jarvis 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    headerTitle: '開始設定 Jarvis',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'Jarvis 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 Jarvis…',
    ...
    recommended: '建議',
    connected: '已連線',
    featuredPitch: '一個訂閱，300+ 前沿模型 — 執行 Jarvis 的建議方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自託管',
        description: '將 Jarvis 指向本機或自託管的 OpenAI 相容端點（vLLM、llama.cpp、Ollama 等）。'
      }
    },
    backToSignIn: '返回登入',
    getKey: '取得金鑰',
    ...
    flowSubtitles: {
      ...
      device_code: '在瀏覽器中開啟驗證頁面 — Jarvis 會自動連線',
      loopback: '開啟瀏覽器登入 — Jarvis 會自動連線',
    ...
    authorizeThere: '請在那裡授權 Jarvis。',
    copyAuthCode: '複製授權碼並貼到下方。',
    pasteAuthCode: '貼上授權碼',
    reopenAuthPage: '重新開啟授權頁面',
    autoBrowser: provider => `已在瀏覽器中開啟 ${provider}。請在那裡授權 Jarvis，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    largeTitle: '此檔案較大',
    largeBody: (label, size) => `${label} 大小為 ${size}。Jarvis 只會顯示前 512 KB。`,
    previewAnyway: '仍然預覽',
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'Jarvis 正在重新啟動...',
      askRestart: '請 Jarvis 重新啟動伺服器',
      lookingRestart: taskId => `Jarvis 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'Jarvis 正在背景執行。可在預覽主控台查看進度。',
      ...
      finishedRestarting: message => `Jarvis 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'Jarvis 無法重新啟動伺服器。',
      stillWorking: 'Jarvis 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'Jarvis 閘道未連線',
      sendFailed: '無法傳送核准回應',
      run: '執行',
      command: '指令',
      moreOptions: '更多核准選項',
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.jarvis/config.yaml）。Jarvis 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Jarvis 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'Jarvis 需要一個憑證才能繼續。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 Jarvis Desktop 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 Jarvis Desktop 以儲存圖片',
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`jarvis gateway` 是否正在執行？'
    }
  },
