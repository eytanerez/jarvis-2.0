...
export const zh: Translations = {
  jarvis: {
    ...
    textMode: '文本模式',
    orbMode: '光球模式',
    classicHint: '切换到经典聊天线程',
    orbHint: '切换到 J.A.R.V.I.S 光球',
    emptyPrompt: '开始说话或输入。',
    interrupt: '停止',
    toolActivity: '工具活动',
    menu: {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: '正在加载 Jarvis 设置',
      loadingSessions: '正在加载最近会话',
      startingDesktopConnection: '正在启动桌面连接',
      startingJarvisDesktop: '正在启动 Jarvis 桌面版…'
    },
    errors: {
      backgroundExited: 'Jarvis 后台进程已退出。',
      backgroundExitedDuringStartup: 'Jarvis 后台进程在启动期间退出。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '你的 Jarvis 后端早于当前桌面构建，可能无法正常工作。请更新以保持一致。',
    updateJarvis: '更新 Jarvis',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 Jarvis Desktop。',
    ...
    native: {
      ...
      rejectAction: '拒绝',
      inputTitle: '需要输入',
      inputBody: 'Jarvis 正在等待你的回应。',
      turnDoneTitle: 'Jarvis 已完成',
      turnDoneBody: '回复已就绪。',
      turnErrorTitle: '本轮失败',
  ...
  settings: {
    ...
    resetConfirm: '将所有设置恢复为 Jarvis 默认值？',
    exportFailed: '导出失败',
    resetFailed: '重置失败',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒仅在 Jarvis 处于后台时触发。',
      kinds: {
        approval: {
          label: '需要批准',
        ...
        input: {
          label: '需要输入',
          description: 'Jarvis 提出了问题，或需要密码或密钥。'
        },
        turnDone: {
          label: '回复就绪',
          description: 'Jarvis 在后台时完成了一轮对话。'
        },
        turnError: {
          label: '本轮失败',
          description: '本轮以错误结束。'
    ...
    appearance: {
      ...
      colorMode: '颜色模式',
      colorModeDesc: '选择固定模式，或让 Jarvis 跟随系统设置。',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: '当 Jarvis 需要本地时间上下文时使用。留空则使用系统时区。',
      agent: {
        imageInputMode: '控制图片附件如何发送给模型。',
        maxTurns: 'Jarvis 停止一次运行前工具调用轮次的上限。'
      },
      terminal: {
        cwd: '工具与终端操作的默认项目目录。',
      ...
      fileReadMaxChars: 'Jarvis 单次文件读取可读取的最大字符数。',
      approvals: {
        mode: 'Jarvis 如何处理需要显式审批的命令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Jarvis 从应用内更新时（无终端提示），保留本地源码修改（暂存）或丢弃（放弃）。通过终端更新时始终会询问。'
      }
    }),
    notch: {
      title: "刘海屏",
      subtitle: "原生刘海屏设置由 Jarvis Notch 管理。此处的更改会发送到配套应用并保存在其 UserDefaults 中。",
      connected: "已连接",
      offline: "离线",
      restart: "重启",
      restarting: "正在重启 Jarvis Notch…",
      restartFailed: "无法重启 Jarvis Notch",
      offlineToast: "Jarvis Notch 处于离线状态。",
      loading: "正在加载刘海屏设置...",
      offlineBannerBefore: "Jarvis Notch 未连接。请使用以下命令构建：",
      offlineBannerAfter: "，然后重启 Jarvis Desktop 即可编辑这些设置。",
      settingSaveFailed: "无法保存刘海屏设置",
      settingsLoadFailed: "刘海屏设置加载失败",
      permissionRequested: label => `已请求${label}。`,
      permissionRequestFailed: label => `无法请求${label}`,
      startup: {
        title: "启动",
        launchAtLoginTitle: "登录时启动 Jarvis",
        launchAtLoginDescription: "登录时自动启动 Jarvis（及刘海屏），让它始终待命。",
        launchAtLoginUnsupported: "此平台不支持该功能。",
        launchAtLoginSaveFailed: "无法更新登录项。",
        launchAtLoginError: "无法更新登录启动设置"
      },
      permissions: {
        title: "权限",
        empty: "尚未报告任何权限状态。",
      ...
      labels: {
        ...
        minimumHoverDuration: "悬停延迟",
        openNotchOnHover: "悬停时展开",
        extendHoverArea: "扩大悬停感应区域",
        hideNonNotchUntilHover: "悬停前隐藏外接显示器胶囊条",
        externalDisplayStyle: "外接显示器样式",
        openNotchWidth: "展开时刘海屏宽度",
        notchHeight: "刘海屏显示高度",
        nonNotchHeight: "外接显示器高度",
        enableMinimalisticUI: "简约界面",
        showEmojis: "表情符号点缀",
        settingsIconInNotch: "刘海屏内的设置图标",
        lightingEffect: "光效",
        enableShadow: "窗口阴影",
        cornerRadiusScaling: "缩放圆角半径",
        useModernCloseAnimation: "现代化关闭动画",
        tileShowLabels: "磁贴标签",
        showStandardMediaControls: "媒体控制标签页",
        autoHideInactiveNotchMediaPlayer: "无播放时自动隐藏播放器",
        mediaController: "媒体控制器",
        coloredSpectrogram: "封面配色可视化",
        enableRealTimeWaveform: "实时波形",
        useMusicVisualizer: "音乐可视化",
        enableLyrics: "歌词",
        showLiveCanvasInDynamicIsland: "实时 Canvas 画面",
        enableFullscreenMediaDetection: "全屏媒体检测",
        enableSneakPeek: "切歌预览提示",
        sneakPeekStyles: "预览提示样式",
        showSneakPeekOnTrackChange: "切歌时显示预览提示",
        showShuffleAndRepeat: "随机播放与循环控制",
        showMediaOutputControl: "媒体输出控制",
        musicSkipBehavior: "跳过行为",
        musicControlWindowEnabled: "浮动音乐控制器",
        inlineHUD: "内嵌 HUD",
        progressBarStyle: "进度条样式",
        showProgressPercentages: "显示百分比",
        systemEventIndicatorShadow: "指示器阴影",
        systemEventIndicatorUseAccent: "使用主题强调色",
        showSongMetadataInClosedNotch: "闭合状态下显示曲目信息",
        enableReminderLiveActivity: "提醒事项实时活动",
        reminderLeadTime: "提醒提前时间",
        reminderSneakPeekDuration: "提醒预览显示秒数",
        reminderPresentationStyle: "提醒样式",
        enableLockScreenLiveActivity: "锁屏实时活动",
        enableLockSounds: "锁屏音效",
        enableLockScreenWeatherWidget: "天气小组件",
        enableLockScreenFocusWidget: "专注模式小组件",
        enableLockScreenReminderWidget: "提醒事项小组件",
        enableLockScreenTimerWidget: "计时器小组件",
        lockScreenWeatherShowsLocation: "显示天气位置",
        lockScreenWeatherShowsSunrise: "日出与日落",
        lockScreenWeatherShowsAQI: "空气质量",
        lockScreenShowCalendarEvent: "日历事件",
        lockScreenShowCalendarCountdown: "日历倒计时",
        lockScreenShowCalendarTimeRemaining: "剩余时间",
        lockScreenCalendarEventLookaheadWindow: "日历预览时间范围",
        lockScreenWeatherVerticalOffset: "天气垂直偏移",
        lockScreenTimerVerticalOffset: "计时器垂直偏移",
        lockScreenTimerWidgetWidth: "计时器小组件宽度",
        showMirror: "摄像头镜像",
        selectedCameraID: "所选摄像头 ID",
        enableCameraDetection: "摄像头隐私指示器",
        enableMicrophoneDetection: "麦克风隐私指示器",
        showBluetoothDeviceConnections: "蓝牙连接 HUD",
        useColorCodedBatteryDisplay: "彩色电量显示",
        useColorCodedVolumeDisplay: "彩色音量显示",
        useSmoothColorGradient: "平滑颜色渐变",
        useCircularBluetoothBatteryIndicator: "圆形电量指示器",
        showBluetoothBatteryPercentageText: "电量百分比文字",
        showBluetoothDeviceNameMarquee: "设备名称跑马灯",
        useBluetoothHUD3DIcon: "3D 设备图标",
        enableSystemHUD: "替换系统 HUD",
        enableVolumeHUD: "音量 HUD",
        enableBrightnessHUD: "亮度 HUD",
        enableKeyboardBacklightHUD: "键盘背光 HUD",
        systemHUDSensitivity: "HUD 灵敏度",
        playVolumeChangeFeedback: "音量反馈音效",
        volumeStepPercent: "音量步进百分比",
        brightnessStepPercent: "亮度步进百分比",
        enableCustomOSD: "自定义 OSD 窗口",
        enableVerticalHUD: "垂直 HUD",
        enableCircularHUD: "圆形 HUD",
        verticalHUDPosition: "垂直 HUD 位置",
        verticalHUDShowValue: "垂直 HUD 数值",
        verticalHUDInteractive: "可交互垂直 HUD",
        verticalHUDHeight: "垂直 HUD 高度",
        circularHUDSize: "圆形 HUD 大小",
        showPowerStatusNotifications: "电源通知",
        showBatteryIndicator: "电量指示器",
        showBatteryPercentage: "电量百分比",
        showBatteryPercentInside: "在指示器内显示百分比",
        showPowerStatusIcons: "电源状态图标",
        playLowBatteryAlertSound: "低电量提示音",
        showChargingBatteryHUD: "充电 HUD",
        showLowBatteryHUD: "低电量 HUD",
        showFullBatteryHUD: "满电 HUD",
        lowBatteryHUDThreshold: "低电量阈值",
        fullBatteryHUDThreshold: "满电阈值",
        lowBatteryHUDStyle: "低电量 HUD 样式",
        fullBatteryHUDStyle: "满电 HUD 样式",
        enableTimerFeature: "计时器标签页",
        timerDisplayMode: "显示模式",
        showTimerPresetsInNotchTab: "预设按钮",
        timerIconColorMode: "图标颜色",
        timerShowsCountdown: "倒计时文字",
        timerShowsLabel: "计时器标签",
        timerShowsProgress: "进度指示器",
        timerProgressStyle: "进度样式",
        mirrorSystemTimer: "同步 macOS 时钟计时器",
        timerControlWindowEnabled: "浮动计时器控制",
        showCalendar: "日历标签页",
        hideCompletedReminders: "隐藏已完成的提醒事项",
        hideAllDayEvents: "隐藏全天事件",
        showFullEventTitles: "显示完整事件标题",
        autoScrollToNextEvent: "自动滚动到下一个事件",
        enableThirdPartyCalendarApp: "在第三方应用中打开事件",
        selectedCalendarApp: "日历应用",
        fantasticalDefaultView: "Fantastical 视图",
        enableNotes: "备忘录标签页",
        enableNotePinning: "置顶备忘录",
        enableNoteSearch: "搜索备忘录",
        enableNoteColorFiltering: "按颜色筛选",
        enableCreateFromClipboard: "从剪贴板创建",
        enableNoteCharCount: "字数统计",
        enableClipboardManager: "剪贴板管理器",
        clipboardHistorySize: "历史记录数量",
        showClipboardIcon: "剪贴板图标",
        clipboardDisplayMode: "显示模式",
        enableColorPickerFeature: "取色器",
        showColorFormats: "显示颜色格式",
        showColorPickerIcon: "取色器图标",
        colorHistorySize: "历史记录数量",
        colorPickerDisplayMode: "显示模式",
        enableDownloadListener: "下载监听",
        enableSafariDownloads: "Safari 下载",
        selectedDownloadIndicatorStyle: "指示器样式",
        selectedDownloadIconStyle: "图标样式",
        dynamicShelf: "文件架标签页",
        openShelfByDefault: "默认打开文件架",
        quickShareProvider: "快速共享方式",
        localSendSelectedDeviceID: "LocalSend 设备 ID",
        copyOnDrag: "拖动时复制",
        autoRemoveShelfItems: "自动移除文件架项目",
        expandedDragDetection: "扩大拖放感应区域",
        enableShortcuts: "键盘快捷键",
        enableGestures: "触控板手势",
        closeGestureEnabled: "关闭手势",
        gestureSensitivity: "手势灵敏度",
        enableHorizontalMusicGestures: "横向音乐手势",
        reverseSwipeGestures: "反转滑动手势",
        reverseScrollGestures: "反转滚动手势",
        enableStatsFeature: "统计标签页",
        autoStartStatsMonitoring: "自动开始监控",
        statsStopWhenNotchCloses: "刘海屏关闭时停止",
        statsUpdateInterval: "更新间隔",
        showCpuGraph: "CPU 图表",
        showMemoryGraph: "内存图表",
        showGpuGraph: "GPU 图表",
        showNetworkGraph: "网络图表",
        showDiskGraph: "磁盘图表",
        enableTerminalFeature: "终端标签页",
        terminalShellPath: "Shell 路径",
        terminalFontFamily: "字体",
        terminalFontSize: "字体大小",
        terminalOpacity: "不透明度",
        terminalMaxHeightFraction: "最大高度比例",
        terminalCursorStyle: "光标样式",
        terminalScrollbackLines: "回滚缓冲行数",
        terminalOptionAsMeta: "将 Option 键作为 Meta 键",
        terminalMouseReporting: "鼠标事件报告",
        terminalBoldAsBright: "粗体显示为高亮色",
        terminalStickyMode: "常驻模式",
        enableThirdPartyExtensions: "第三方扩展",
        enableExtensionLiveActivities: "实时活动",
        enableExtensionLockScreenWidgets: "锁屏小组件",
        enableExtensionNotchExperiences: "刘海屏体验",
        enableExtensionNotchTabs: "扩展标签页",
        enableExtensionNotchMinimalisticOverrides: "简约模式覆写",
        enableExtensionNotchInteractiveWebViews: "可交互网页视图",
        enableExtensionFileSharing: "文件共享",
        extensionDiagnosticsLoggingEnabled: "诊断日志",
        extensionLiveActivityCapacity: "实时活动数量上限",
        extensionLockScreenWidgetCapacity: "小组件数量上限",
        extensionNotchExperienceCapacity: "体验数量上限",
      },
      optionLabels: {
        ...
        "sneakPeekStyles:Default": "默认",
        "sneakPeekStyles:Inline": "内嵌",
        "musicSkipBehavior:track": "跳过整曲",
        "musicSkipBehavior:tenSecond": "跳过十秒",
        "progressBarStyle:Hierarchical": "分层",
        "progressBarStyle:Gradient": "渐变",
        "progressBarStyle:Segmented": "分段",
        "reminderPresentationStyle:Ring": "环形",
        "reminderPresentationStyle:Digital": "数字",
        "reminderPresentationStyle:Minutes": "分钟数",
        "verticalHUDPosition:left": "左",
        "verticalHUDPosition:right": "右",
        "lowBatteryHUDStyle:standard": "标准",
        "lowBatteryHUDStyle:compact": "紧凑",
        "fullBatteryHUDStyle:standard": "标准",
        "fullBatteryHUDStyle:compact": "紧凑",
        "timerDisplayMode:tab": "标签页",
        "timerDisplayMode:popover": "弹出窗口",
        "timerIconColorMode:Adaptive": "自适应",
        "timerIconColorMode:Solid": "纯色",
        "timerProgressStyle:Bar": "进度条",
        "timerProgressStyle:Ring": "环形",
        "selectedCalendarApp:fantastical": "Fantastical",
        "selectedCalendarApp:notionCalendar": "Notion Calendar",
        "fantasticalDefaultView:mini": "迷你视图",
        "fantasticalDefaultView:calendar": "日历视图",
        "clipboardDisplayMode:popover": "弹出窗口",
        "clipboardDisplayMode:panel": "面板",
        "clipboardDisplayMode:separateTab": "独立标签页",
        "colorPickerDisplayMode:popover": "弹出窗口",
        "colorPickerDisplayMode:panel": "面板",
        "selectedDownloadIndicatorStyle:Progress": "进度",
        "selectedDownloadIndicatorStyle:Percentage": "百分比",
        "selectedDownloadIndicatorStyle:Circle": "圆形",
        "selectedDownloadIconStyle:Only app icon": "仅应用图标",
        "selectedDownloadIconStyle:Only download icon": "仅下载图标",
        "selectedDownloadIconStyle:Icon and app icon": "图标与应用图标",
        "terminalCursorStyle:blinkBlock": "闪烁方块",
        "terminalCursorStyle:block": "方块",
    ...
    about: {
      ...
      automaticUpdatesDesc: 'Jarvis 会在后台自动检查更新，并在有可用更新时通知你。',
      branchCommit: (branch, commit) => `分支 ${branch} · 提交 ${commit}`,
      terminalUpdate: '终端命令',
      terminalUpdateDesc: '打开桌面终端，并从此检出运行 CLI 更新程序。',
      runJarvisUpdate: '运行 jarvis update',
      runJarvisUpdateToast: '正在终端中运行 jarvis update...',
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Jarvis Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Jarvis 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      envOverrideDesc: '取消设置 JARVIS_DESKTOP_REMOTE_URL 和 JARVIS_DESKTOP_REMOTE_TOKEN 后才会使用下面保存的设置。',
      localTitle: '本地网关',
      localDesc: '在 localhost 启动私有 Jarvis 后端。这是默认方式，并且可离线工作。',
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 Jarvis 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      remoteUrlTitle: '远程 URL',
      remoteUrlDesc: '远程 dashboard 后端的基础 URL。支持路径前缀，例如 /jarvis。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Jarvis Desktop 将使用已保存设置重新连接。',
      savedMessage: '已保存，下一次重启生效。',
      connectedTo: (baseUrl, version) => `已连接到 ${baseUrl}${version ? ` · Jarvis ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: '使用订阅登录，无需复制 API 密钥。Jarvis 会在应用中为你完成浏览器登录。',
      connected: '已连接',
      collapse: '收起',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: '设置', detail: '配置 Jarvis 桌面端' },
    ...
    jarvisActiveSessions: (version, count) => `Jarvis ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 用户 ID', placeholder: '@jarvis:example.org' },
    ...
    platformIntro: {
      ...
      signal: '在可访问的位置运行 signal-cli REST 桥接，然后把 Jarvis 指向该 URL 和已注册的电话号码。',
      whatsapp: '启动 Jarvis 自带的 WhatsApp 桥接，首次运行时扫描二维码，然后启用该平台。',
      bluebubbles:
        '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Jarvis 指向该 URL。',
      ...
      weixin:
        '运行 `jarvis gateway setup`，选择 Weixin，然后使用个人微信账号扫描并确认二维码。Jarvis 会通过腾讯 iLink Bot API 连接并保存凭据。',
      qqbot: '在 QQ 开放平台 (q.qq.com) 注册一个应用，复制 App ID 和 Client Secret。',
      api_server:
        '把 Jarvis 暴露为兼容 OpenAI 的 API。设置一个鉴权密钥，然后把 Open WebUI / LobeChat 等指向 host:port。',
  ...
  profiles: {
    ...
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 Jarvis 环境：各自拥有独立的配置、技能和 SOUL.md。',
    nameLabel: '名称',
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '按 cron 表达式排程一个提示词。Jarvis 会运行它，并把结果发送到你选择的目的地。',
  ...
  composer: {
    ...
    placeholderStarting: '正在启动 Jarvis…',
    placeholderReconnecting: '正在重新连接 Jarvis…',
    ...
    attachUrlDesc: 'Jarvis 将抓取该页面并作为本回合的上下文。',
  ...
  install: {
    ...
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 Jarvis CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 Jarvis 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
    activeDesc: '这是一次性设置。Jarvis 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  onboarding: {
    headerTitle: '开始设置 Jarvis',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'Jarvis 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 Jarvis…',
    ...
    recommended: '推荐',
    connected: '已连接',
    featuredPitch: '一个订阅，300+ 前沿模型 — 运行 Jarvis 的推荐方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自托管',
        description: '将 Jarvis 指向本地或自托管的 OpenAI 兼容端点 (vLLM、llama.cpp、Ollama 等)。'
      }
    },
    backToSignIn: '返回登录',
    getKey: '获取密钥',
    ...
    flowSubtitles: {
      ...
      device_code: '在浏览器中打开验证页面 — Jarvis 会自动连接',
      loopback: '打开浏览器登录 — Jarvis 会自动连接',
    ...
    authorizeThere: '请在那里授权 Jarvis。',
    copyAuthCode: '复制授权码并粘贴到下面。',
    pasteAuthCode: '粘贴授权码',
    reopenAuthPage: '重新打开授权页面',
    autoBrowser: provider => `已在浏览器中打开 ${provider}。请在那里授权 Jarvis，连接会自动完成，无需复制或粘贴。`,
  ...
  preview: {
    ...
    largeTitle: '此文件较大',
    largeBody: (label, size) => `${label} 大小为 ${size}。Jarvis 只会显示前 512 KB。`,
    previewAnyway: '仍然预览',
    ...
    web: {
      ...
      failedToLoad: '预览加载失败',
      tryAgain: '重试',
      restarting: 'Jarvis 正在重启...',
      askRestart: '让 Jarvis 重启服务器',
      lookingRestart: taskId => `Jarvis 正在查找要重启的预览服务器 (${taskId})`,
      restartingTitle: '正在重启预览服务器',
      restartingMessage: 'Jarvis 正在后台工作。可在预览控制台查看进度。',
      ...
      finishedRestarting: message => `Jarvis 已完成预览服务器重启${message ? `: ${message}` : ''}`,
      failedRestarting: message => `服务器重启失败：${message}`,
      unknownError: '未知错误',
      restartedTitle: '预览服务器已重启',
      reloadingNow: '正在重新加载预览。',
      restartFailedTitle: '预览重启失败',
      restartFailedMessage: 'Jarvis 无法重启服务器。',
      stillWorking: 'Jarvis 仍在工作，但还没有收到重启结果。服务器命令可能正在前台运行。',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'Jarvis 网关未连接',
      sendFailed: '无法发送审批响应',
      run: '运行',
      command: '命令',
      moreOptions: '更多审批选项',
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.jarvis/config.yaml)。Jarvis 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'Jarvis 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
    sudoPlaceholder: 'sudo 密码',
    secretTitle: '需要密钥',
    secretDesc: 'Jarvis 需要一个凭据才能继续。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重启 Jarvis 桌面版后可使用保存图片。',
    restartToSaveImages: '重启 Jarvis 桌面版以保存图片',
    ...
    handoff: {
      ...
      timedOut: '等待网关超时。`jarvis gateway` 是否正在运行？'
    }
  },
