...
export const en: Translations = {
  jarvis: {
    ...
    textMode: 'Text mode',
    orbMode: 'Orb mode',
    classicHint: 'Switch to the classic chat thread',
    orbHint: 'Switch to the J.A.R.V.I.S orb',
    emptyPrompt: 'Speak or type to begin.',
    interrupt: 'Stop',
  ...
  boot: {
    ready: 'Jarvis Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Jarvis settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingJarvisDesktop: 'Starting Jarvis Desktop…'
    },
    errors: {
      backgroundExited: 'Jarvis background process exited.',
      backgroundExitedDuringStartup: 'Jarvis background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Jarvis backend is older than this desktop build and may not work correctly. Update to align them.',
    updateJarvis: 'Update Jarvis',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Jarvis Desktop.',
    ...
    native: {
      ...
      inputBody: 'Jarvis is waiting for your response.',
      turnDoneTitle: 'Jarvis finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Jarvis defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Jarvis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Jarvis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Jarvis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Jarvis follow your system setting.',
    ...
    notch: {
      title: "The Notch",
      subtitle: "Native notch settings live in Jarvis Notch. Changes here are sent to the companion app and stored in its UserDefaults.",
      connected: "connected",
      offline: "offline",
      restart: "Restart",
      restarting: "Restarting Jarvis Notch…",
      restartFailed: "Could not restart Jarvis Notch",
      offlineToast: "Jarvis Notch is offline.",
      loading: "Loading notch settings...",
      offlineBannerBefore: "Jarvis Notch is not connected. Build it with ",
      offlineBannerAfter: " and restart Jarvis Desktop to edit these settings.",
      settingSaveFailed: "Could not save notch setting",
      settingsLoadFailed: "Notch settings failed to load",
      permissionRequested: label => `Requested ${label}.`,
      permissionRequestFailed: label => `Could not request ${label}`,
      startup: {
        title: "Startup",
        launchAtLoginTitle: "Launch Jarvis at login",
        launchAtLoginDescription: "Starts Jarvis (and with it, the notch) when you log in, so it is always there.",
        launchAtLoginUnsupported: "Not supported on this platform.",
        launchAtLoginSaveFailed: "Could not update the login item.",
        launchAtLoginError: "Could not update launch at login"
      },
      permissions: {
        title: "Permissions",
        empty: "No permission status reported yet.",
        request: "Request",
        granted: "Granted",
        denied: "Denied",
        unknown: "Unknown"
      ...
      labels: {
        ...
        minimumHoverDuration: "Hover delay",
        openNotchOnHover: "Open on hover",
        extendHoverArea: "Extend hover area",
        hideNonNotchUntilHover: "Hide external display pill until hover",
        externalDisplayStyle: "External display style",
        openNotchWidth: "Open notch width",
        notchHeight: "Notch display height",
        nonNotchHeight: "External display height",
        enableMinimalisticUI: "Minimal interface",
        showEmojis: "Emoji accents",
        settingsIconInNotch: "Settings icon in notch",
        lightingEffect: "Lighting effect",
        enableShadow: "Window shadow",
        cornerRadiusScaling: "Scale corner radius",
        useModernCloseAnimation: "Modern close animation",
        tileShowLabels: "Tile labels",
        showStandardMediaControls: "Media controls tab",
        autoHideInactiveNotchMediaPlayer: "Auto-hide inactive player",
        mediaController: "Media controller",
        coloredSpectrogram: "Artwork-colored visualizer",
        enableRealTimeWaveform: "Real-time waveform",
        useMusicVisualizer: "Music visualizer",
        enableLyrics: "Lyrics",
        showLiveCanvasInDynamicIsland: "Live canvas art",
        enableFullscreenMediaDetection: "Fullscreen media detection",
        enableSneakPeek: "Track-change sneak peek",
        sneakPeekStyles: "Sneak peek style",
        showSneakPeekOnTrackChange: "Sneak peek on track change",
        showShuffleAndRepeat: "Shuffle and repeat controls",
        showMediaOutputControl: "Media output control",
        musicSkipBehavior: "Skip behavior",
        musicControlWindowEnabled: "Floating music controller",
        inlineHUD: "Inline HUD",
        progressBarStyle: "Progress style",
        showProgressPercentages: "Show percentages",
        systemEventIndicatorShadow: "Indicator shadow",
        systemEventIndicatorUseAccent: "Use accent color",
        showSongMetadataInClosedNotch: "Song metadata while closed",
        enableReminderLiveActivity: "Reminder live activity",
        reminderLeadTime: "Reminder lead time",
        reminderSneakPeekDuration: "Reminder sneak peek seconds",
        reminderPresentationStyle: "Reminder style",
        enableLockScreenLiveActivity: "Lock screen live activities",
        enableLockSounds: "Lock sounds",
        enableLockScreenWeatherWidget: "Weather widget",
        enableLockScreenFocusWidget: "Focus widget",
        enableLockScreenReminderWidget: "Reminder widget",
        enableLockScreenTimerWidget: "Timer widget",
        lockScreenWeatherShowsLocation: "Weather location",
        lockScreenWeatherShowsSunrise: "Sunrise and sunset",
        lockScreenWeatherShowsAQI: "Air quality",
        lockScreenShowCalendarEvent: "Calendar event",
        lockScreenShowCalendarCountdown: "Calendar countdown",
        lockScreenShowCalendarTimeRemaining: "Time remaining",
        lockScreenCalendarEventLookaheadWindow: "Calendar lookahead",
        lockScreenWeatherVerticalOffset: "Weather vertical offset",
        lockScreenTimerVerticalOffset: "Timer vertical offset",
        lockScreenTimerWidgetWidth: "Timer widget width",
        showMirror: "Camera mirror",
        selectedCameraID: "Selected camera ID",
        enableCameraDetection: "Camera privacy indicator",
        enableMicrophoneDetection: "Microphone privacy indicator",
        showBluetoothDeviceConnections: "Bluetooth connection HUD",
        useColorCodedBatteryDisplay: "Color-coded battery",
        useColorCodedVolumeDisplay: "Color-coded volume",
        useSmoothColorGradient: "Smooth color gradient",
        useCircularBluetoothBatteryIndicator: "Circular battery indicator",
        showBluetoothBatteryPercentageText: "Battery percentage text",
        showBluetoothDeviceNameMarquee: "Device name marquee",
        useBluetoothHUD3DIcon: "3D device icon",
        enableSystemHUD: "System HUD replacement",
        enableVolumeHUD: "Volume HUD",
        enableBrightnessHUD: "Brightness HUD",
        enableKeyboardBacklightHUD: "Keyboard backlight HUD",
        systemHUDSensitivity: "HUD sensitivity",
        playVolumeChangeFeedback: "Volume feedback sound",
        volumeStepPercent: "Volume step percent",
        brightnessStepPercent: "Brightness step percent",
        enableCustomOSD: "Custom OSD window",
        enableVerticalHUD: "Vertical HUD",
        enableCircularHUD: "Circular HUD",
        verticalHUDPosition: "Vertical HUD position",
        verticalHUDShowValue: "Vertical HUD value",
        verticalHUDInteractive: "Interactive vertical HUD",
        verticalHUDHeight: "Vertical HUD height",
        circularHUDSize: "Circular HUD size",
        showPowerStatusNotifications: "Power notifications",
        showBatteryIndicator: "Battery indicator",
        showBatteryPercentage: "Battery percentage",
        showBatteryPercentInside: "Percentage inside indicator",
        showPowerStatusIcons: "Power status icons",
        playLowBatteryAlertSound: "Low battery sound",
        showChargingBatteryHUD: "Charging HUD",
        showLowBatteryHUD: "Low battery HUD",
        showFullBatteryHUD: "Full battery HUD",
        lowBatteryHUDThreshold: "Low battery threshold",
        fullBatteryHUDThreshold: "Full battery threshold",
        lowBatteryHUDStyle: "Low battery HUD style",
        fullBatteryHUDStyle: "Full battery HUD style",
        enableTimerFeature: "Timer tab",
        timerDisplayMode: "Display mode",
        showTimerPresetsInNotchTab: "Preset buttons",
        timerIconColorMode: "Icon color",
        timerShowsCountdown: "Countdown text",
        timerShowsLabel: "Timer label",
        timerShowsProgress: "Progress indicator",
        timerProgressStyle: "Progress style",
        mirrorSystemTimer: "Mirror macOS Clock timers",
        timerControlWindowEnabled: "Floating timer controls",
        showCalendar: "Calendar tab",
        hideCompletedReminders: "Hide completed reminders",
        hideAllDayEvents: "Hide all-day events",
        showFullEventTitles: "Full event titles",
        autoScrollToNextEvent: "Auto-scroll to next event",
        enableThirdPartyCalendarApp: "Open events in third-party app",
        selectedCalendarApp: "Calendar app",
        fantasticalDefaultView: "Fantastical view",
        enableNotes: "Notes tab",
        enableNotePinning: "Pin notes",
        enableNoteSearch: "Search notes",
        enableNoteColorFiltering: "Filter by color",
        enableCreateFromClipboard: "Create from clipboard",
        enableNoteCharCount: "Character count",
        enableClipboardManager: "Clipboard manager",
        clipboardHistorySize: "History size",
        showClipboardIcon: "Clipboard icon",
        clipboardDisplayMode: "Display mode",
        enableColorPickerFeature: "Color picker",
        showColorFormats: "Show formats",
        showColorPickerIcon: "Color picker icon",
        colorHistorySize: "History size",
        colorPickerDisplayMode: "Display mode",
        enableDownloadListener: "Download listener",
        enableSafariDownloads: "Safari downloads",
        selectedDownloadIndicatorStyle: "Indicator style",
        selectedDownloadIconStyle: "Icon style",
        dynamicShelf: "Shelf tab",
        openShelfByDefault: "Open shelf by default",
        quickShareProvider: "Quick share provider",
        localSendSelectedDeviceID: "LocalSend device ID",
        copyOnDrag: "Copy on drag",
        autoRemoveShelfItems: "Auto-remove shelf items",
        expandedDragDetection: "Expanded drag detection",
        enableShortcuts: "Keyboard shortcuts",
        enableGestures: "Trackpad gestures",
        closeGestureEnabled: "Close gesture",
        gestureSensitivity: "Gesture sensitivity",
        enableHorizontalMusicGestures: "Horizontal music gestures",
        reverseSwipeGestures: "Reverse swipe gestures",
        reverseScrollGestures: "Reverse scroll gestures",
        enableStatsFeature: "Stats tab",
        autoStartStatsMonitoring: "Auto-start monitoring",
        statsStopWhenNotchCloses: "Stop when notch closes",
        statsUpdateInterval: "Update interval",
        showCpuGraph: "CPU graph",
        showMemoryGraph: "Memory graph",
        showGpuGraph: "GPU graph",
        showNetworkGraph: "Network graph",
        showDiskGraph: "Disk graph",
        enableTerminalFeature: "Terminal tab",
        terminalShellPath: "Shell path",
        terminalFontFamily: "Font family",
        terminalFontSize: "Font size",
        terminalOpacity: "Opacity",
        terminalMaxHeightFraction: "Max height fraction",
        terminalCursorStyle: "Cursor style",
        terminalScrollbackLines: "Scrollback lines",
        terminalOptionAsMeta: "Option as Meta",
        terminalMouseReporting: "Mouse reporting",
        terminalBoldAsBright: "Bold as bright",
        terminalStickyMode: "Sticky mode",
        enableThirdPartyExtensions: "Third-party extensions",
        enableExtensionLiveActivities: "Live activities",
        enableExtensionLockScreenWidgets: "Lock screen widgets",
        enableExtensionNotchExperiences: "Notch experiences",
        enableExtensionNotchTabs: "Extension tabs",
        enableExtensionNotchMinimalisticOverrides: "Minimal overrides",
        enableExtensionNotchInteractiveWebViews: "Interactive web views",
        enableExtensionFileSharing: "File sharing",
        extensionDiagnosticsLoggingEnabled: "Diagnostics logging",
        extensionLiveActivityCapacity: "Live activity capacity",
        extensionLockScreenWidgetCapacity: "Widget capacity",
        extensionNotchExperienceCapacity: "Experience capacity",
      },
      optionLabels: {
        "externalDisplayStyle:Standard Notch": "Standard Notch",
        "externalDisplayStyle:Dynamic Island": "Dynamic Island",
        "mediaController:Now Playing": "Now Playing",
        "mediaController:Apple Music": "Apple Music",
        "mediaController:Spotify": "Spotify",
        "mediaController:Youtube Music": "YouTube Music",
        "mediaController:Amazon Music": "Amazon Music",
        "sneakPeekStyles:Default": "Default",
        "sneakPeekStyles:Inline": "Inline",
        "musicSkipBehavior:track": "Track skip",
        "musicSkipBehavior:tenSecond": "Ten seconds",
        "progressBarStyle:Hierarchical": "Hierarchical",
        "progressBarStyle:Gradient": "Gradient",
        "progressBarStyle:Segmented": "Segmented",
        "reminderPresentationStyle:Ring": "Ring",
        "reminderPresentationStyle:Digital": "Digital",
        "reminderPresentationStyle:Minutes": "Minutes",
        "verticalHUDPosition:left": "Left",
        "verticalHUDPosition:right": "Right",
        "lowBatteryHUDStyle:standard": "Standard",
        "lowBatteryHUDStyle:compact": "Compact",
        "fullBatteryHUDStyle:standard": "Standard",
        "fullBatteryHUDStyle:compact": "Compact",
        "timerDisplayMode:tab": "Tab",
        "timerDisplayMode:popover": "Popover",
        "timerIconColorMode:Adaptive": "Adaptive",
        "timerIconColorMode:Solid": "Solid",
        "timerProgressStyle:Bar": "Bar",
        "timerProgressStyle:Ring": "Ring",
        "selectedCalendarApp:fantastical": "Fantastical",
        "selectedCalendarApp:notionCalendar": "Notion Calendar",
        "fantasticalDefaultView:mini": "Mini",
        "fantasticalDefaultView:calendar": "Calendar",
        "clipboardDisplayMode:popover": "Popover",
        "clipboardDisplayMode:panel": "Panel",
        "clipboardDisplayMode:separateTab": "Separate tab",
        "colorPickerDisplayMode:popover": "Popover",
        "colorPickerDisplayMode:panel": "Panel",
        "selectedDownloadIndicatorStyle:Progress": "Progress",
        "selectedDownloadIndicatorStyle:Percentage": "Percentage",
        "selectedDownloadIndicatorStyle:Circle": "Circle",
        "selectedDownloadIconStyle:Only app icon": "App icon only",
        "selectedDownloadIconStyle:Only download icon": "Download icon only",
        "selectedDownloadIconStyle:Icon and app icon": "Icon and app icon",
        "terminalCursorStyle:blinkBlock": "Blink block",
    ...
    config: {
      ...
      loading: 'Loading Jarvis configuration...',
    ...
    gateway: {
      ...
      intro:
        'Jarvis Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Jarvis backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset JARVIS_DESKTOP_REMOTE_URL and JARVIS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Jarvis backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Jarvis backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /jarvis.',
      ...
      restartingMessage: 'Jarvis Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Jarvis ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Jarvis runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Jarvis desktop' },
    ...
    jarvisActiveSessions: (version, count) => `Jarvis ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@jarvis:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Jarvis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Jarvis will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    attachUrlDesc: 'Jarvis will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Jarvis can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Jarvis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Jarvis will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
  ...
  install: {
    ...
    oneTimeTitle: 'Jarvis needs a one-time install',
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Jarvis CLI or desktop instance is running. Stop any running Jarvis instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Jarvis installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Jarvis",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Jarvis is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Jarvis',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Jarvis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Jarvis connects automatically',
      loopback: 'Opens your browser to sign in — Jarvis connects automatically',
    ...
    authorizeThere: 'Authorize Jarvis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Jarvis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Jarvis inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Jarvis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Jarvis is restarting...',
      askRestart: 'Ask Jarvis to restart the server',
      lookingRestart: taskId => `Jarvis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Jarvis is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Jarvis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Jarvis could not restart the server.',
      stillWorking:
        'Jarvis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Jarvis is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Jarvis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.jarvis/config.yaml). Jarvis won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Jarvis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Jarvis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Jarvis Desktop to use Save Image.',
    restartToSaveImages: 'Restart Jarvis Desktop to save images',
