...
export const ja = defineLocale({
  ...
  settings: {
    ...
    notch: {
      title: "ザ・ノッチ",
      subtitle: "ネイティブのノッチ設定は Jarvis Notch 内にあります。ここでの変更はコンパニオンアプリに送信され、その UserDefaults に保存されます。",
      connected: "接続済み",
      offline: "オフライン",
      restart: "再起動",
      restarting: "Jarvis Notch を再起動しています…",
      restartFailed: "Jarvis Notch を再起動できませんでした",
      offlineToast: "Jarvis Notch はオフラインです。",
      loading: "ノッチ設定を読み込み中...",
      offlineBannerBefore: "Jarvis Notch が接続されていません。次のコマンドでビルドしてください: ",
      offlineBannerAfter: " を実行し、Jarvis Desktop を再起動するとこれらの設定を編集できます。",
      settingSaveFailed: "ノッチ設定を保存できませんでした",
      settingsLoadFailed: "ノッチ設定の読み込みに失敗しました",
      permissionRequested: label => `${label}をリクエストしました。`,
      permissionRequestFailed: label => `${label}をリクエストできませんでした`,
      startup: {
        title: "起動",
        launchAtLoginTitle: "ログイン時に Jarvis を起動",
        launchAtLoginDescription: "ログイン時に Jarvis（およびノッチ）を自動的に起動し、常に使える状態にします。",
        launchAtLoginUnsupported: "このプラットフォームではサポートされていません。",
        launchAtLoginSaveFailed: "ログイン項目を更新できませんでした。",
        launchAtLoginError: "ログイン時起動を更新できませんでした"
      },
      permissions: {
        title: "権限",
        empty: "権限の状態はまだ報告されていません。",
        request: "リクエスト",
        granted: "許可済み",
        denied: "拒否",
        unknown: "不明"
      ...
      labels: {
        ...
        minimumHoverDuration: "ホバー遅延",
        openNotchOnHover: "ホバーで開く",
        extendHoverArea: "ホバー範囲を拡張",
        hideNonNotchUntilHover: "ホバーするまで外部ディスプレイのピルを非表示",
        externalDisplayStyle: "外部ディスプレイのスタイル",
        openNotchWidth: "展開時のノッチ幅",
        notchHeight: "ノッチ表示の高さ",
        nonNotchHeight: "外部ディスプレイの高さ",
        enableMinimalisticUI: "ミニマルインターフェース",
        showEmojis: "絵文字アクセント",
        settingsIconInNotch: "ノッチ内の設定アイコン",
        lightingEffect: "ライティングエフェクト",
        enableShadow: "ウィンドウの影",
        cornerRadiusScaling: "角丸半径をスケール",
        useModernCloseAnimation: "モダンな閉じるアニメーション",
        tileShowLabels: "タイルラベル",
        showStandardMediaControls: "メディアコントロールタブ",
        autoHideInactiveNotchMediaPlayer: "非アクティブ時にプレイヤーを自動非表示",
        mediaController: "メディアコントローラー",
        coloredSpectrogram: "アートワークカラーのビジュアライザー",
        enableRealTimeWaveform: "リアルタイム波形",
        useMusicVisualizer: "ミュージックビジュアライザー",
        enableLyrics: "歌詞",
        showLiveCanvasInDynamicIsland: "ライブキャンバスアート",
        enableFullscreenMediaDetection: "全画面メディア検出",
        enableSneakPeek: "曲変更時のスニークピーク",
        sneakPeekStyles: "スニークピークのスタイル",
        showSneakPeekOnTrackChange: "曲変更時にスニークピークを表示",
        showShuffleAndRepeat: "シャッフルとリピートのコントロール",
        showMediaOutputControl: "メディア出力コントロール",
        musicSkipBehavior: "スキップ動作",
        musicControlWindowEnabled: "フローティングミュージックコントローラー",
        inlineHUD: "インライン HUD",
        progressBarStyle: "プログレスのスタイル",
        showProgressPercentages: "パーセンテージを表示",
        systemEventIndicatorShadow: "インジケーターの影",
        systemEventIndicatorUseAccent: "アクセントカラーを使用",
        showSongMetadataInClosedNotch: "閉じた状態で曲情報を表示",
        enableReminderLiveActivity: "リマインダーライブアクティビティ",
        reminderLeadTime: "リマインダーの通知タイミング",
        reminderSneakPeekDuration: "リマインダースニークピークの表示秒数",
        reminderPresentationStyle: "リマインダーのスタイル",
        enableLockScreenLiveActivity: "ロック画面のライブアクティビティ",
        enableLockSounds: "ロック音",
        enableLockScreenWeatherWidget: "天気ウィジェット",
        enableLockScreenFocusWidget: "集中モードウィジェット",
        enableLockScreenReminderWidget: "リマインダーウィジェット",
        enableLockScreenTimerWidget: "タイマーウィジェット",
        lockScreenWeatherShowsLocation: "天気の場所を表示",
        lockScreenWeatherShowsSunrise: "日の出と日の入り",
        lockScreenWeatherShowsAQI: "大気質",
        lockScreenShowCalendarEvent: "カレンダーの予定",
        lockScreenShowCalendarCountdown: "カレンダーのカウントダウン",
        lockScreenShowCalendarTimeRemaining: "残り時間",
        lockScreenCalendarEventLookaheadWindow: "カレンダーの先読み時間",
        lockScreenWeatherVerticalOffset: "天気の垂直オフセット",
        lockScreenTimerVerticalOffset: "タイマーの垂直オフセット",
        lockScreenTimerWidgetWidth: "タイマーウィジェットの幅",
        showMirror: "カメラミラー",
        selectedCameraID: "選択中のカメラ ID",
        enableCameraDetection: "カメラプライバシーインジケーター",
        enableMicrophoneDetection: "マイクプライバシーインジケーター",
        showBluetoothDeviceConnections: "Bluetooth 接続 HUD",
        useColorCodedBatteryDisplay: "色分けバッテリー表示",
        useColorCodedVolumeDisplay: "色分け音量表示",
        useSmoothColorGradient: "滑らかなカラーグラデーション",
        useCircularBluetoothBatteryIndicator: "円形バッテリーインジケーター",
        showBluetoothBatteryPercentageText: "バッテリー残量のテキスト表示",
        showBluetoothDeviceNameMarquee: "デバイス名のマーキー表示",
        useBluetoothHUD3DIcon: "3D デバイスアイコン",
        enableSystemHUD: "システム HUD の置き換え",
        enableVolumeHUD: "音量 HUD",
        enableBrightnessHUD: "輝度 HUD",
        enableKeyboardBacklightHUD: "キーボードバックライト HUD",
        systemHUDSensitivity: "HUD の感度",
        playVolumeChangeFeedback: "音量変更フィードバック音",
        volumeStepPercent: "音量の増減幅（%）",
        brightnessStepPercent: "輝度の増減幅（%）",
        enableCustomOSD: "カスタム OSD ウィンドウ",
        enableVerticalHUD: "垂直 HUD",
        enableCircularHUD: "円形 HUD",
        verticalHUDPosition: "垂直 HUD の位置",
        verticalHUDShowValue: "垂直 HUD の数値表示",
        verticalHUDInteractive: "操作可能な垂直 HUD",
        verticalHUDHeight: "垂直 HUD の高さ",
        circularHUDSize: "円形 HUD のサイズ",
        showPowerStatusNotifications: "電源通知",
        showBatteryIndicator: "バッテリーインジケーター",
        showBatteryPercentage: "バッテリー残量（%）",
        showBatteryPercentInside: "インジケーター内にパーセンテージ表示",
        showPowerStatusIcons: "電源状態アイコン",
        playLowBatteryAlertSound: "バッテリー低下時のサウンド",
        showChargingBatteryHUD: "充電中 HUD",
        showLowBatteryHUD: "バッテリー低下 HUD",
        showFullBatteryHUD: "満充電 HUD",
        lowBatteryHUDThreshold: "バッテリー低下のしきい値",
        fullBatteryHUDThreshold: "満充電のしきい値",
        lowBatteryHUDStyle: "バッテリー低下 HUD のスタイル",
        fullBatteryHUDStyle: "満充電 HUD のスタイル",
        enableTimerFeature: "タイマータブ",
        timerDisplayMode: "表示モード",
        showTimerPresetsInNotchTab: "プリセットボタン",
        timerIconColorMode: "アイコンの色",
        timerShowsCountdown: "カウントダウンテキスト",
        timerShowsLabel: "タイマーラベル",
        timerShowsProgress: "進捗インジケーター",
        timerProgressStyle: "進捗のスタイル",
        mirrorSystemTimer: "macOS 時計アプリのタイマーをミラー",
        timerControlWindowEnabled: "フローティングタイマーコントロール",
        showCalendar: "カレンダータブ",
        hideCompletedReminders: "完了したリマインダーを非表示",
        hideAllDayEvents: "終日の予定を非表示",
        showFullEventTitles: "予定名を省略せず表示",
        autoScrollToNextEvent: "次の予定へ自動スクロール",
        enableThirdPartyCalendarApp: "サードパーティアプリで予定を開く",
        selectedCalendarApp: "カレンダーアプリ",
        fantasticalDefaultView: "Fantastical の表示",
        enableNotes: "メモタブ",
        enableNotePinning: "メモをピン留め",
        enableNoteSearch: "メモを検索",
        enableNoteColorFiltering: "色でフィルター",
        enableCreateFromClipboard: "クリップボードから作成",
        enableNoteCharCount: "文字数カウント",
        enableClipboardManager: "クリップボードマネージャー",
        clipboardHistorySize: "履歴の保存数",
        showClipboardIcon: "クリップボードアイコン",
        clipboardDisplayMode: "表示モード",
        enableColorPickerFeature: "カラーピッカー",
        showColorFormats: "フォーマットを表示",
        showColorPickerIcon: "カラーピッカーアイコン",
        colorHistorySize: "履歴の保存数",
        colorPickerDisplayMode: "表示モード",
        enableDownloadListener: "ダウンロード検知",
        enableSafariDownloads: "Safari のダウンロード",
        selectedDownloadIndicatorStyle: "インジケーターのスタイル",
        selectedDownloadIconStyle: "アイコンのスタイル",
        dynamicShelf: "シェルフタブ",
        openShelfByDefault: "デフォルトでシェルフを開く",
        quickShareProvider: "クイック共有プロバイダー",
        localSendSelectedDeviceID: "LocalSend デバイス ID",
        copyOnDrag: "ドラッグ時にコピー",
        autoRemoveShelfItems: "シェルフの項目を自動削除",
        expandedDragDetection: "ドラッグ検出範囲を拡張",
        enableShortcuts: "キーボードショートカット",
        enableGestures: "トラックパッドジェスチャー",
        closeGestureEnabled: "閉じるジェスチャー",
        gestureSensitivity: "ジェスチャーの感度",
        enableHorizontalMusicGestures: "水平方向のミュージックジェスチャー",
        reverseSwipeGestures: "スワイプジェスチャーを反転",
        reverseScrollGestures: "スクロールジェスチャーを反転",
        enableStatsFeature: "統計タブ",
        autoStartStatsMonitoring: "自動でモニタリングを開始",
        statsStopWhenNotchCloses: "ノッチが閉じたら停止",
        statsUpdateInterval: "更新間隔",
        showCpuGraph: "CPU グラフ",
        showMemoryGraph: "メモリグラフ",
        showGpuGraph: "GPU グラフ",
        showNetworkGraph: "ネットワークグラフ",
        showDiskGraph: "ディスクグラフ",
        enableTerminalFeature: "ターミナルタブ",
        terminalShellPath: "シェルのパス",
        terminalFontFamily: "フォントファミリー",
        terminalFontSize: "フォントサイズ",
        terminalOpacity: "不透明度",
        terminalMaxHeightFraction: "最大高さの割合",
        terminalCursorStyle: "カーソルのスタイル",
        terminalScrollbackLines: "スクロールバック行数",
        terminalOptionAsMeta: "Option キーを Meta として使用",
        terminalMouseReporting: "マウスレポート",
        terminalBoldAsBright: "太字を明るい色として表示",
        terminalStickyMode: "スティッキーモード",
        enableThirdPartyExtensions: "サードパーティ拡張機能",
        enableExtensionLiveActivities: "ライブアクティビティ",
        enableExtensionLockScreenWidgets: "ロック画面ウィジェット",
        enableExtensionNotchExperiences: "ノッチ体験",
        enableExtensionNotchTabs: "拡張機能タブ",
        enableExtensionNotchMinimalisticOverrides: "ミニマルモードの上書き",
        enableExtensionNotchInteractiveWebViews: "インタラクティブな Web ビュー",
        enableExtensionFileSharing: "ファイル共有",
        extensionDiagnosticsLoggingEnabled: "診断ログ",
        extensionLiveActivityCapacity: "ライブアクティビティの上限数",
        extensionLockScreenWidgetCapacity: "ウィジェットの上限数",
        extensionNotchExperienceCapacity: "体験の上限数",
      },
      optionLabels: {
        ...
        "sneakPeekStyles:Default": "デフォルト",
        "sneakPeekStyles:Inline": "インライン",
        "musicSkipBehavior:track": "トラックスキップ",
        "musicSkipBehavior:tenSecond": "10 秒スキップ",
        "progressBarStyle:Hierarchical": "階層",
        "progressBarStyle:Gradient": "グラデーション",
        "progressBarStyle:Segmented": "セグメント",
        "reminderPresentationStyle:Ring": "リング",
        "reminderPresentationStyle:Digital": "デジタル",
        "reminderPresentationStyle:Minutes": "分表示",
        "verticalHUDPosition:left": "左",
        "verticalHUDPosition:right": "右",
        "lowBatteryHUDStyle:standard": "標準",
        "lowBatteryHUDStyle:compact": "コンパクト",
        "fullBatteryHUDStyle:standard": "標準",
        "fullBatteryHUDStyle:compact": "コンパクト",
        "timerDisplayMode:tab": "タブ",
        "timerDisplayMode:popover": "ポップオーバー",
        "timerIconColorMode:Adaptive": "適応型",
        "timerIconColorMode:Solid": "単色",
        "timerProgressStyle:Bar": "バー",
        "timerProgressStyle:Ring": "リング",
        "selectedCalendarApp:fantastical": "Fantastical",
        "selectedCalendarApp:notionCalendar": "Notion Calendar",
        "fantasticalDefaultView:mini": "ミニ",
        "fantasticalDefaultView:calendar": "カレンダー",
        "clipboardDisplayMode:popover": "ポップオーバー",
        "clipboardDisplayMode:panel": "パネル",
        "clipboardDisplayMode:separateTab": "個別タブ",
        "colorPickerDisplayMode:popover": "ポップオーバー",
        "colorPickerDisplayMode:panel": "パネル",
        "selectedDownloadIndicatorStyle:Progress": "進捗",
        "selectedDownloadIndicatorStyle:Percentage": "パーセンテージ",
        "selectedDownloadIndicatorStyle:Circle": "円形",
        "selectedDownloadIconStyle:Only app icon": "アプリアイコンのみ",
        "selectedDownloadIconStyle:Only download icon": "ダウンロードアイコンのみ",
        "selectedDownloadIconStyle:Icon and app icon": "アイコンとアプリアイコン",
        "terminalCursorStyle:blinkBlock": "点滅ブロック",
        "terminalCursorStyle:block": "ブロック",
        "terminalCursorStyle:underline": "アンダーライン",
        "terminalCursorStyle:bar": "バー",
      }
    },
    about: {
