 ...
 *
 * A public install can end up with `origin=git@github.com:eytanerez/jarvis-2.0.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/eytanerez/jarvis-2.0.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/eytanerez/jarvis-2.0'
