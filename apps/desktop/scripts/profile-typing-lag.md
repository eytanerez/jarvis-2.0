...
cd apps/desktop
XCURSOR_SIZE=24 JARVIS_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/jarvis-typing
# → /tmp/jarvis-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/jarvis-typing.before.heapsnapshot
# → /tmp/jarvis-typing.after.heapsnapshot
```
