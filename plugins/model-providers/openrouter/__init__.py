...
# default-to-newest philosophy in brain/anthropic_adapter._get_anthropic_max_output.
...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by jarvis_cli/models.py
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See jarvis-agent#42991 (disable case)
            ...
            # live token-spend probe in jarvis-agent#43432). Route the existing
