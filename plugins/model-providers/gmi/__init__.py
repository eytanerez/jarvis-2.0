...
gmi = ProviderProfile(
    ...
    # The generic profile.default_headers fallback in run_brain.py and
    # brain/auxiliary_client.py picks this up at client construction time.
    default_headers={"User-Agent": f"JarvisBrain/{_JARVIS_VERSION}"},
