...
required — uses aiohttp which is already a Jarvis dependency.
...
def interactive_setup() -> None:
    ...
    ``jarvis_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Jarvis delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # jarvis_cli/setup.py::_setup_mattermost function.
