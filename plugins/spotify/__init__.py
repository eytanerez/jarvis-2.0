...
``_check_spotify_available()`` — when the user has not run ``jarvis auth
spotify``, the tools remain registered (so they appear in ``jarvis
...
The Spotify auth flow (``jarvis auth spotify``), CLI plumbing, and docs
