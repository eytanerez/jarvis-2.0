# Jarvis Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.jarvis/plugins/jarvis-achievements/state.json` (existing unlock state)
  - `~/.jarvis/plugins/jarvis-achievements/scan_snapshot.json` (new)
  - `~/.jarvis/plugins/jarvis-achievements/scan_checkpoint.json` (new)
