# Jarvis Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.jarvis/plugins/jarvis-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.jarvis/plugins/jarvis-achievements/scan_checkpoint.json`.
