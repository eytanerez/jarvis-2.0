 ...
 *
 * Symptom: in `jarvis --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@jarvis/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using jarvis --tui and as i type multiline my caret at the end will often ' +
